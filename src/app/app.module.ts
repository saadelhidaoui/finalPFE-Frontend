...
import {ModerateurModule} from './module/moderateur/moderateur.module';
import {ModerateurRoutingModule} from './module/moderateur/moderateur-routing.module';
import {AdherentModule} from './module/adherent/adherent.module';
import {AdherentRoutingModule} from './module/adherent/adherent-routing.module';
@NgModule({
    imports: [
        ButtonModule,
        PasswordModule,
