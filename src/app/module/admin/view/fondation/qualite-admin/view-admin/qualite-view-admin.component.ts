...
@Component({
  selector: 'app-qualite-view-admin',
  templateUrl: './qualite-view-admin.component.html',
  styleUrls: ['./qualite-view-admin.component.css']
})
export class QualiteViewAdminComponent implements OnInit {
