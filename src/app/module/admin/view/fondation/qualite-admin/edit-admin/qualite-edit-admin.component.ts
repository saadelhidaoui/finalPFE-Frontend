...
@Component({
  selector: 'app-qualite-edit-admin',
  templateUrl: './qualite-edit-admin.component.html',
  styleUrls: ['./qualite-edit-admin.component.css']
})
export class QualiteEditAdminComponent implements OnInit {
