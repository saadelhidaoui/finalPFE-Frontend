...
@Component({
  selector: 'app-etat-projet-view-admin',
  templateUrl: './etat-projet-view-admin.component.html',
  styleUrls: ['./etat-projet-view-admin.component.css']
})
export class EtatProjetViewAdminComponent implements OnInit {
