...
@Component({
  selector: 'app-etat-projet-create-admin',
  templateUrl: './etat-projet-create-admin.component.html',
  styleUrls: ['./etat-projet-create-admin.component.css']
})
export class EtatProjetCreateAdminComponent implements OnInit {
