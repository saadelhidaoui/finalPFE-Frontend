...
@Component({
  selector: 'app-etat-projet-list-admin',
  templateUrl: './etat-projet-list-admin.component.html',
  styleUrls: ['./etat-projet-list-admin.component.css']
})
export class EtatProjetListAdminComponent implements OnInit {
   // declarations
