...
@Component({
  selector: 'app-piece-jointe-mission-list-admin',
  templateUrl: './piece-jointe-mission-list-admin.component.html',
  styleUrls: ['./piece-jointe-mission-list-admin.component.css']
})
export class PieceJointeMissionListAdminComponent implements OnInit {
   // declarations
