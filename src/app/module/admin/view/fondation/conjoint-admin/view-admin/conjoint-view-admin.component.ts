...
@Component({
  selector: 'app-conjoint-view-admin',
  templateUrl: './conjoint-view-admin.component.html',
  styleUrls: ['./conjoint-view-admin.component.css']
})
export class ConjointViewAdminComponent implements OnInit {
