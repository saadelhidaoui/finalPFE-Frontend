...
@Component({
  selector: 'app-conjoint-edit-admin',
  templateUrl: './conjoint-edit-admin.component.html',
  styleUrls: ['./conjoint-edit-admin.component.css']
})
export class ConjointEditAdminComponent implements OnInit {
