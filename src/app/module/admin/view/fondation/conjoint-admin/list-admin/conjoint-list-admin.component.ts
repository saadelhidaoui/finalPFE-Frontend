...
@Component({
  selector: 'app-conjoint-list-admin',
  templateUrl: './conjoint-list-admin.component.html',
  styleUrls: ['./conjoint-list-admin.component.css']
})
export class ConjointListAdminComponent implements OnInit {
   // declarations
