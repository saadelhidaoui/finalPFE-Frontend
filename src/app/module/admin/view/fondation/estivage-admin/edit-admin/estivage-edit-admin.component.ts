...
@Component({
  selector: 'app-estivage-edit-admin',
  templateUrl: './estivage-edit-admin.component.html',
  styleUrls: ['./estivage-edit-admin.component.css']
})
export class EstivageEditAdminComponent implements OnInit {
