...
@Component({
  selector: 'app-estivage-list-admin',
  templateUrl: './estivage-list-admin.component.html',
  styleUrls: ['./estivage-list-admin.component.css']
})
export class EstivageListAdminComponent implements OnInit {
   // declarations
