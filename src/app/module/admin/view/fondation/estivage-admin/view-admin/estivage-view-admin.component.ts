...
@Component({
  selector: 'app-estivage-view-admin',
  templateUrl: './estivage-view-admin.component.html',
  styleUrls: ['./estivage-view-admin.component.css']
})
export class EstivageViewAdminComponent implements OnInit {
