...
@Component({
  selector: 'app-impression-carte-list-admin',
  templateUrl: './impression-carte-list-admin.component.html',
  styleUrls: ['./impression-carte-list-admin.component.css']
})
export class ImpressionCarteListAdminComponent implements OnInit {
   // declarations
