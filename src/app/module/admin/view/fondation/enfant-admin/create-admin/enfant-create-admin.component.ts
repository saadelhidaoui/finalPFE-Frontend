...
@Component({
  selector: 'app-enfant-create-admin',
  templateUrl: './enfant-create-admin.component.html',
  styleUrls: ['./enfant-create-admin.component.css']
})
export class EnfantCreateAdminComponent implements OnInit {
