...
@Component({
  selector: 'app-enfant-edit-admin',
  templateUrl: './enfant-edit-admin.component.html',
  styleUrls: ['./enfant-edit-admin.component.css']
})
export class EnfantEditAdminComponent implements OnInit {
