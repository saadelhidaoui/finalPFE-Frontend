...
@Component({
  selector: 'app-enfant-view-admin',
  templateUrl: './enfant-view-admin.component.html',
  styleUrls: ['./enfant-view-admin.component.css']
})
export class EnfantViewAdminComponent implements OnInit {
