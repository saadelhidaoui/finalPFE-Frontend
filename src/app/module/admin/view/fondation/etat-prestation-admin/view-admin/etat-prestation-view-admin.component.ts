...
@Component({
  selector: 'app-etat-prestation-view-admin',
  templateUrl: './etat-prestation-view-admin.component.html',
  styleUrls: ['./etat-prestation-view-admin.component.css']
})
export class EtatPrestationViewAdminComponent implements OnInit {
