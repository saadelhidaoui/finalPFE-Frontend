...
@Component({
  selector: 'app-etat-prestation-list-admin',
  templateUrl: './etat-prestation-list-admin.component.html',
  styleUrls: ['./etat-prestation-list-admin.component.css']
})
export class EtatPrestationListAdminComponent implements OnInit {
   // declarations
