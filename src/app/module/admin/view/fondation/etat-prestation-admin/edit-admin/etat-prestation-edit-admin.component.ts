...
@Component({
  selector: 'app-etat-prestation-edit-admin',
  templateUrl: './etat-prestation-edit-admin.component.html',
  styleUrls: ['./etat-prestation-edit-admin.component.css']
})
export class EtatPrestationEditAdminComponent implements OnInit {
