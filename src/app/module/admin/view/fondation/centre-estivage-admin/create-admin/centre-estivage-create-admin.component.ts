...
@Component({
  selector: 'app-centre-estivage-create-admin',
  templateUrl: './centre-estivage-create-admin.component.html',
  styleUrls: ['./centre-estivage-create-admin.component.css']
})
export class CentreEstivageCreateAdminComponent implements OnInit {
