...
@Component({
  selector: 'app-centre-estivage-view-admin',
  templateUrl: './centre-estivage-view-admin.component.html',
  styleUrls: ['./centre-estivage-view-admin.component.css']
})
export class CentreEstivageViewAdminComponent implements OnInit {
