...
@Component({
  selector: 'app-centre-estivage-edit-admin',
  templateUrl: './centre-estivage-edit-admin.component.html',
  styleUrls: ['./centre-estivage-edit-admin.component.css']
})
export class CentreEstivageEditAdminComponent implements OnInit {
