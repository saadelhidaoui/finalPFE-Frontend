...
@Component({
  selector: 'app-centre-estivage-list-admin',
  templateUrl: './centre-estivage-list-admin.component.html',
  styleUrls: ['./centre-estivage-list-admin.component.css']
})
export class CentreEstivageListAdminComponent implements OnInit {
   // declarations
