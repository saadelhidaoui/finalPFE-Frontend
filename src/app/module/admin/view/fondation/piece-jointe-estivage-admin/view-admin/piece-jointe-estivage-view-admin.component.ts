...
@Component({
  selector: 'app-piece-jointe-estivage-view-admin',
  templateUrl: './piece-jointe-estivage-view-admin.component.html',
  styleUrls: ['./piece-jointe-estivage-view-admin.component.css']
})
export class PieceJointeEstivageViewAdminComponent implements OnInit {
