...
@Component({
  selector: 'app-piece-jointe-estivage-create-admin',
  templateUrl: './piece-jointe-estivage-create-admin.component.html',
  styleUrls: ['./piece-jointe-estivage-create-admin.component.css']
})
export class PieceJointeEstivageCreateAdminComponent implements OnInit {
