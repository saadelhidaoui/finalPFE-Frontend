...
@Component({
  selector: 'app-piece-jointe-estivage-edit-admin',
  templateUrl: './piece-jointe-estivage-edit-admin.component.html',
  styleUrls: ['./piece-jointe-estivage-edit-admin.component.css']
})
export class PieceJointeEstivageEditAdminComponent implements OnInit {
