...
@Component({
  selector: 'app-piece-jointe-estivage-list-admin',
  templateUrl: './piece-jointe-estivage-list-admin.component.html',
  styleUrls: ['./piece-jointe-estivage-list-admin.component.css']
})
export class PieceJointeEstivageListAdminComponent implements OnInit {
   // declarations
