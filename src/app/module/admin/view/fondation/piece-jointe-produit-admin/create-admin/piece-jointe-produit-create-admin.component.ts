...
@Component({
  selector: 'app-piece-jointe-produit-create-admin',
  templateUrl: './piece-jointe-produit-create-admin.component.html',
  styleUrls: ['./piece-jointe-produit-create-admin.component.css']
})
export class PieceJointeProduitCreateAdminComponent implements OnInit {
