...
@Component({
  selector: 'app-piece-jointe-produit-view-admin',
  templateUrl: './piece-jointe-produit-view-admin.component.html',
  styleUrls: ['./piece-jointe-produit-view-admin.component.css']
})
export class PieceJointeProduitViewAdminComponent implements OnInit {
