...
@Component({
  selector: 'app-piece-jointe-produit-edit-admin',
  templateUrl: './piece-jointe-produit-edit-admin.component.html',
  styleUrls: ['./piece-jointe-produit-edit-admin.component.css']
})
export class PieceJointeProduitEditAdminComponent implements OnInit {
