...
@Component({
  selector: 'app-piece-jointe-produit-list-admin',
  templateUrl: './piece-jointe-produit-list-admin.component.html',
  styleUrls: ['./piece-jointe-produit-list-admin.component.css']
})
export class PieceJointeProduitListAdminComponent implements OnInit {
   // declarations
