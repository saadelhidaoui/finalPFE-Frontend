...
@Component({
  selector: 'app-profil-edit-admin',
  templateUrl: './profil-edit-admin.component.html',
  styleUrls: ['./profil-edit-admin.component.css']
})
export class ProfilEditAdminComponent implements OnInit {
