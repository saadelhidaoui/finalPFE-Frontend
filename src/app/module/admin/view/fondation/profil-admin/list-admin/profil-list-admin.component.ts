...
@Component({
  selector: 'app-profil-list-admin',
  templateUrl: './profil-list-admin.component.html',
  styleUrls: ['./profil-list-admin.component.css']
})
export class ProfilListAdminComponent implements OnInit {
   // declarations
