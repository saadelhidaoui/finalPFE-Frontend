...
@Component({
  selector: 'app-etat-carte-edit-admin',
  templateUrl: './etat-carte-edit-admin.component.html',
  styleUrls: ['./etat-carte-edit-admin.component.css']
})
export class EtatCarteEditAdminComponent implements OnInit {
