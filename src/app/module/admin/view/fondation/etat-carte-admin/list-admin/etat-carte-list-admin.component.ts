...
@Component({
  selector: 'app-etat-carte-list-admin',
  templateUrl: './etat-carte-list-admin.component.html',
  styleUrls: ['./etat-carte-list-admin.component.css']
})
export class EtatCarteListAdminComponent implements OnInit {
   // declarations
