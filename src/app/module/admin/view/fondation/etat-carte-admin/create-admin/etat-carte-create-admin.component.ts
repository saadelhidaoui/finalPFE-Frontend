...
@Component({
  selector: 'app-etat-carte-create-admin',
  templateUrl: './etat-carte-create-admin.component.html',
  styleUrls: ['./etat-carte-create-admin.component.css']
})
export class EtatCarteCreateAdminComponent implements OnInit {
