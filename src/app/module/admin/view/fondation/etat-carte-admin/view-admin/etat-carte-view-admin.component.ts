...
@Component({
  selector: 'app-etat-carte-view-admin',
  templateUrl: './etat-carte-view-admin.component.html',
  styleUrls: ['./etat-carte-view-admin.component.css']
})
export class EtatCarteViewAdminComponent implements OnInit {
