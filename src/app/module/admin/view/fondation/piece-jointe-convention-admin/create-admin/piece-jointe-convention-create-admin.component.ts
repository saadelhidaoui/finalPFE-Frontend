...
@Component({
  selector: 'app-piece-jointe-convention-create-admin',
  templateUrl: './piece-jointe-convention-create-admin.component.html',
  styleUrls: ['./piece-jointe-convention-create-admin.component.css']
})
export class PieceJointeConventionCreateAdminComponent implements OnInit {
