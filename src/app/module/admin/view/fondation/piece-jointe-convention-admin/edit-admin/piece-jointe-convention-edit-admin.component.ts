...
@Component({
  selector: 'app-piece-jointe-convention-edit-admin',
  templateUrl: './piece-jointe-convention-edit-admin.component.html',
  styleUrls: ['./piece-jointe-convention-edit-admin.component.css']
})
export class PieceJointeConventionEditAdminComponent implements OnInit {
