...
@Component({
  selector: 'app-piece-jointe-convention-view-admin',
  templateUrl: './piece-jointe-convention-view-admin.component.html',
  styleUrls: ['./piece-jointe-convention-view-admin.component.css']
})
export class PieceJointeConventionViewAdminComponent implements OnInit {
