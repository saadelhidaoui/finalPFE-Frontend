...
@Component({
  selector: 'app-piece-jointe-convention-list-admin',
  templateUrl: './piece-jointe-convention-list-admin.component.html',
  styleUrls: ['./piece-jointe-convention-list-admin.component.css']
})
export class PieceJointeConventionListAdminComponent implements OnInit {
   // declarations
