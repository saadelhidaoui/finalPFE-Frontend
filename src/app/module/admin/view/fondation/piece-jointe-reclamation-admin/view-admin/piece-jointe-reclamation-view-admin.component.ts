...
@Component({
  selector: 'app-piece-jointe-reclamation-view-admin',
  templateUrl: './piece-jointe-reclamation-view-admin.component.html',
  styleUrls: ['./piece-jointe-reclamation-view-admin.component.css']
})
export class PieceJointeReclamationViewAdminComponent implements OnInit {
