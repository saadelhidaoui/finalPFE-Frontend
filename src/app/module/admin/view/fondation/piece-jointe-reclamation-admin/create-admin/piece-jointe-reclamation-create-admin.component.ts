...
@Component({
  selector: 'app-piece-jointe-reclamation-create-admin',
  templateUrl: './piece-jointe-reclamation-create-admin.component.html',
  styleUrls: ['./piece-jointe-reclamation-create-admin.component.css']
})
export class PieceJointeReclamationCreateAdminComponent implements OnInit {
