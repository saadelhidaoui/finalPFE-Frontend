...
@Component({
  selector: 'app-gestion-reclamation-view-admin',
  templateUrl: './gestion-reclamation-view-admin.component.html',
  styleUrls: ['./gestion-reclamation-view-admin.component.css']
})
export class GestionReclamationViewAdminComponent implements OnInit {
