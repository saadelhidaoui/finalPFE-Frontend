...
@Component({
  selector: 'app-gestion-reclamation-edit-admin',
  templateUrl: './gestion-reclamation-edit-admin.component.html',
  styleUrls: ['./gestion-reclamation-edit-admin.component.css']
})
export class GestionReclamationEditAdminComponent implements OnInit {
