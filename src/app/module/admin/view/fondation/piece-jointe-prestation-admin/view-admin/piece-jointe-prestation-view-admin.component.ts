...
@Component({
  selector: 'app-piece-jointe-prestation-view-admin',
  templateUrl: './piece-jointe-prestation-view-admin.component.html',
  styleUrls: ['./piece-jointe-prestation-view-admin.component.css']
})
export class PieceJointePrestationViewAdminComponent implements OnInit {
