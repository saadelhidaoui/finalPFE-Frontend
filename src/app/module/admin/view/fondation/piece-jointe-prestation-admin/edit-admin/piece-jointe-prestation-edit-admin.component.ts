...
@Component({
  selector: 'app-piece-jointe-prestation-edit-admin',
  templateUrl: './piece-jointe-prestation-edit-admin.component.html',
  styleUrls: ['./piece-jointe-prestation-edit-admin.component.css']
})
export class PieceJointePrestationEditAdminComponent implements OnInit {
