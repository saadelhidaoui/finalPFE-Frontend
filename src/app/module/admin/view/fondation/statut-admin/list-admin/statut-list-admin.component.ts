...
@Component({
  selector: 'app-statut-list-admin',
  templateUrl: './statut-list-admin.component.html',
  styleUrls: ['./statut-list-admin.component.css']
})
export class StatutListAdminComponent implements OnInit {
   // declarations
