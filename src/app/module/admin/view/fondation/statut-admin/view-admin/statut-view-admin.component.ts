...
@Component({
  selector: 'app-statut-view-admin',
  templateUrl: './statut-view-admin.component.html',
  styleUrls: ['./statut-view-admin.component.css']
})
export class StatutViewAdminComponent implements OnInit {
