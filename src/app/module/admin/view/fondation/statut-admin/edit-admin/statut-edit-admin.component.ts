...
@Component({
  selector: 'app-statut-edit-admin',
  templateUrl: './statut-edit-admin.component.html',
  styleUrls: ['./statut-edit-admin.component.css']
})
export class StatutEditAdminComponent implements OnInit {
