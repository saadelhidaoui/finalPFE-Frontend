...
@Component({
  selector: 'app-piece-jointe-rendez-vous-view-admin',
  templateUrl: './piece-jointe-rendez-vous-view-admin.component.html',
  styleUrls: ['./piece-jointe-rendez-vous-view-admin.component.css']
})
export class PieceJointeRendezVousViewAdminComponent implements OnInit {
