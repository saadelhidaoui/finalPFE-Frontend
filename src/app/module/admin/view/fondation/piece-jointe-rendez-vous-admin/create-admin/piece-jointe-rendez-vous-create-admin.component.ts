...
@Component({
  selector: 'app-piece-jointe-rendez-vous-create-admin',
  templateUrl: './piece-jointe-rendez-vous-create-admin.component.html',
  styleUrls: ['./piece-jointe-rendez-vous-create-admin.component.css']
})
export class PieceJointeRendezVousCreateAdminComponent implements OnInit {
