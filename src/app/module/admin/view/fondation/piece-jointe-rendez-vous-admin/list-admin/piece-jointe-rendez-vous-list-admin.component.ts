...
@Component({
  selector: 'app-piece-jointe-rendez-vous-list-admin',
  templateUrl: './piece-jointe-rendez-vous-list-admin.component.html',
  styleUrls: ['./piece-jointe-rendez-vous-list-admin.component.css']
})
export class PieceJointeRendezVousListAdminComponent implements OnInit {
   // declarations
