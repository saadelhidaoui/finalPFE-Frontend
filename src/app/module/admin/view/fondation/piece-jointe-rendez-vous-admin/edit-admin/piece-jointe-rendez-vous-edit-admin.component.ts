...
@Component({
  selector: 'app-piece-jointe-rendez-vous-edit-admin',
  templateUrl: './piece-jointe-rendez-vous-edit-admin.component.html',
  styleUrls: ['./piece-jointe-rendez-vous-edit-admin.component.css']
})
export class PieceJointeRendezVousEditAdminComponent implements OnInit {
