...
@Component({
  selector: 'app-rendez-vous-edit-admin',
  templateUrl: './rendez-vous-edit-admin.component.html',
  styleUrls: ['./rendez-vous-edit-admin.component.css']
})
export class RendezVousEditAdminComponent implements OnInit {
