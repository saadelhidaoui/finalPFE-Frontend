...
@Component({
  selector: 'app-rendez-vous-create-admin',
  templateUrl: './rendez-vous-create-admin.component.html',
  styleUrls: ['./rendez-vous-create-admin.component.css']
})
export class RendezVousCreateAdminComponent implements OnInit {
