...
@Component({
  selector: 'app-rendez-vous-list-admin',
  templateUrl: './rendez-vous-list-admin.component.html',
  styleUrls: ['./rendez-vous-list-admin.component.css']
})
export class RendezVousListAdminComponent implements OnInit {
   // declarations
