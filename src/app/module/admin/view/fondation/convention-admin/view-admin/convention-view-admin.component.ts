...
@Component({
  selector: 'app-convention-view-admin',
  templateUrl: './convention-view-admin.component.html',
  styleUrls: ['./convention-view-admin.component.css']
})
export class ConventionViewAdminComponent implements OnInit {
