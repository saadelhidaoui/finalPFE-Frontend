...
@Component({
  selector: 'app-convention-edit-admin',
  templateUrl: './convention-edit-admin.component.html',
  styleUrls: ['./convention-edit-admin.component.css']
})
export class ConventionEditAdminComponent implements OnInit {
