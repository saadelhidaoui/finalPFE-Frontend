...
@Component({
  selector: 'app-demande-estivage-view-admin',
  templateUrl: './demande-estivage-view-admin.component.html',
  styleUrls: ['./demande-estivage-view-admin.component.css']
})
export class DemandeEstivageViewAdminComponent implements OnInit {
