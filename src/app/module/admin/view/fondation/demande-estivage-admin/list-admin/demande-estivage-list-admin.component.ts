...
@Component({
  selector: 'app-demande-estivage-list-admin',
  templateUrl: './demande-estivage-list-admin.component.html',
  styleUrls: ['./demande-estivage-list-admin.component.css']
})
export class DemandeEstivageListAdminComponent implements OnInit {
   // declarations
