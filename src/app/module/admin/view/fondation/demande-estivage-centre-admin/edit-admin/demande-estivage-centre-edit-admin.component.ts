...
@Component({
  selector: 'app-demande-estivage-centre-edit-admin',
  templateUrl: './demande-estivage-centre-edit-admin.component.html',
  styleUrls: ['./demande-estivage-centre-edit-admin.component.css']
})
export class DemandeEstivageCentreEditAdminComponent implements OnInit {
