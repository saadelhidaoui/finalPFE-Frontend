...
@Component({
  selector: 'app-demande-estivage-centre-list-admin',
  templateUrl: './demande-estivage-centre-list-admin.component.html',
  styleUrls: ['./demande-estivage-centre-list-admin.component.css']
})
export class DemandeEstivageCentreListAdminComponent implements OnInit {
   // declarations
