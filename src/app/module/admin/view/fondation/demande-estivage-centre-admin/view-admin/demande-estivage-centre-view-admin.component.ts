...
@Component({
  selector: 'app-demande-estivage-centre-view-admin',
  templateUrl: './demande-estivage-centre-view-admin.component.html',
  styleUrls: ['./demande-estivage-centre-view-admin.component.css']
})
export class DemandeEstivageCentreViewAdminComponent implements OnInit {
