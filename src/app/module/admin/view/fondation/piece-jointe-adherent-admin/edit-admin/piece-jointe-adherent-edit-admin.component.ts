...
@Component({
  selector: 'app-piece-jointe-adherent-edit-admin',
  templateUrl: './piece-jointe-adherent-edit-admin.component.html',
  styleUrls: ['./piece-jointe-adherent-edit-admin.component.css']
})
export class PieceJointeAdherentEditAdminComponent implements OnInit {
