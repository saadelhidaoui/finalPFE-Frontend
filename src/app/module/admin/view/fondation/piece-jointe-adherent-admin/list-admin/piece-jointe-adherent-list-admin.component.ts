...
@Component({
  selector: 'app-piece-jointe-adherent-list-admin',
  templateUrl: './piece-jointe-adherent-list-admin.component.html',
  styleUrls: ['./piece-jointe-adherent-list-admin.component.css']
})
export class PieceJointeAdherentListAdminComponent implements OnInit {
   // declarations
