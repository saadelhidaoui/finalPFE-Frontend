...
@Component({
  selector: 'app-piece-jointe-adherent-view-admin',
  templateUrl: './piece-jointe-adherent-view-admin.component.html',
  styleUrls: ['./piece-jointe-adherent-view-admin.component.css']
})
export class PieceJointeAdherentViewAdminComponent implements OnInit {
