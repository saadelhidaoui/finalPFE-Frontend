...
@Component({
  selector: 'app-niveau-importance-view-admin',
  templateUrl: './niveau-importance-view-admin.component.html',
  styleUrls: ['./niveau-importance-view-admin.component.css']
})
export class NiveauImportanceViewAdminComponent implements OnInit {
