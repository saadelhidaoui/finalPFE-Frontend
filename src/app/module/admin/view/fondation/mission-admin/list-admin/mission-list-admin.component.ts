...
@Component({
  selector: 'app-mission-list-admin',
  templateUrl: './mission-list-admin.component.html',
  styleUrls: ['./mission-list-admin.component.css']
})
export class MissionListAdminComponent implements OnInit {
   // declarations
