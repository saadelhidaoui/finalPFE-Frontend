...
@Component({
  selector: 'app-piece-jointe-projet-list-admin',
  templateUrl: './piece-jointe-projet-list-admin.component.html',
  styleUrls: ['./piece-jointe-projet-list-admin.component.css']
})
export class PieceJointeProjetListAdminComponent implements OnInit {
   // declarations
