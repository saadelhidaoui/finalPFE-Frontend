...
@Component({
  selector: 'app-piece-jointe-projet-edit-admin',
  templateUrl: './piece-jointe-projet-edit-admin.component.html',
  styleUrls: ['./piece-jointe-projet-edit-admin.component.css']
})
export class PieceJointeProjetEditAdminComponent implements OnInit {
