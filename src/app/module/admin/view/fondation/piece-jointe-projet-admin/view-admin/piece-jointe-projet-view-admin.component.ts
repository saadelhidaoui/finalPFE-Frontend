...
@Component({
  selector: 'app-piece-jointe-projet-view-admin',
  templateUrl: './piece-jointe-projet-view-admin.component.html',
  styleUrls: ['./piece-jointe-projet-view-admin.component.css']
})
export class PieceJointeProjetViewAdminComponent implements OnInit {
