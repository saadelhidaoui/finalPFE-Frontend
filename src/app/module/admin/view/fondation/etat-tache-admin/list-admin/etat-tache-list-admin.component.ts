...
@Component({
  selector: 'app-etat-tache-list-admin',
  templateUrl: './etat-tache-list-admin.component.html',
  styleUrls: ['./etat-tache-list-admin.component.css']
})
export class EtatTacheListAdminComponent implements OnInit {
   // declarations
