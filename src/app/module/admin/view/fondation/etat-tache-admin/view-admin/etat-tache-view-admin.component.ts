...
@Component({
  selector: 'app-etat-tache-view-admin',
  templateUrl: './etat-tache-view-admin.component.html',
  styleUrls: ['./etat-tache-view-admin.component.css']
})
export class EtatTacheViewAdminComponent implements OnInit {
