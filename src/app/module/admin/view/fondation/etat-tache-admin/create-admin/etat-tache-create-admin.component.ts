...
@Component({
  selector: 'app-etat-tache-create-admin',
  templateUrl: './etat-tache-create-admin.component.html',
  styleUrls: ['./etat-tache-create-admin.component.css']
})
export class EtatTacheCreateAdminComponent implements OnInit {
