...
@Component({
  selector: 'app-adherent-list-admin',
  templateUrl: './adherent-list-admin.component.html',
  styleUrls: ['./adherent-list-admin.component.css']
})
export class AdherentListAdminComponent implements OnInit {
   // declarations
