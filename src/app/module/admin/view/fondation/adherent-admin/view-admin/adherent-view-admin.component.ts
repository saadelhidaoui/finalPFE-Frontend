...
@Component({
  selector: 'app-adherent-view-admin',
  templateUrl: './adherent-view-admin.component.html',
  styleUrls: ['./adherent-view-admin.component.css']
})
export class AdherentViewAdminComponent implements OnInit {
