...
@Component({
  selector: 'app-moderateur-create-admin',
  templateUrl: './moderateur-create-admin.component.html',
  styleUrls: ['./moderateur-create-admin.component.css']
})
export class ModerateurCreateAdminComponent implements OnInit {
