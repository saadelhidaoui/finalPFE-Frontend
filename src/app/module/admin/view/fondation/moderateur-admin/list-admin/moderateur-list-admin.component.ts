...
@Component({
  selector: 'app-moderateur-list-admin',
  templateUrl: './moderateur-list-admin.component.html',
  styleUrls: ['./moderateur-list-admin.component.css']
})
export class ModerateurListAdminComponent implements OnInit {
   // declarations
