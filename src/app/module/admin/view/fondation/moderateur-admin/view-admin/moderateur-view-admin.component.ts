...
@Component({
  selector: 'app-moderateur-view-admin',
  templateUrl: './moderateur-view-admin.component.html',
  styleUrls: ['./moderateur-view-admin.component.css']
})
export class ModerateurViewAdminComponent implements OnInit {
