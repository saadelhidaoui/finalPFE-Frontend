...
@Component({
  selector: 'app-moderateur-edit-admin',
  templateUrl: './moderateur-edit-admin.component.html',
  styleUrls: ['./moderateur-edit-admin.component.css']
})
export class ModerateurEditAdminComponent implements OnInit {
