...
@Component({
  selector: 'app-etat-demande-estivage-view-admin',
  templateUrl: './etat-demande-estivage-view-admin.component.html',
  styleUrls: ['./etat-demande-estivage-view-admin.component.css']
})
export class EtatDemandeEstivageViewAdminComponent implements OnInit {
