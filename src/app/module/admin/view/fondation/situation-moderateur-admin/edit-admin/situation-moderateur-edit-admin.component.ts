...
@Component({
  selector: 'app-situation-moderateur-edit-admin',
  templateUrl: './situation-moderateur-edit-admin.component.html',
  styleUrls: ['./situation-moderateur-edit-admin.component.css']
})
export class SituationModerateurEditAdminComponent implements OnInit {
