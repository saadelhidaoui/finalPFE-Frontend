...
@Component({
  selector: 'app-situation-moderateur-view-admin',
  templateUrl: './situation-moderateur-view-admin.component.html',
  styleUrls: ['./situation-moderateur-view-admin.component.css']
})
export class SituationModerateurViewAdminComponent implements OnInit {
