...
@Component({
  selector: 'app-situation-moderateur-list-admin',
  templateUrl: './situation-moderateur-list-admin.component.html',
  styleUrls: ['./situation-moderateur-list-admin.component.css']
})
export class SituationModerateurListAdminComponent implements OnInit {
   // declarations
