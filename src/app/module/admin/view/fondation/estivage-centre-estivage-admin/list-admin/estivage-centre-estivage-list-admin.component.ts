...
@Component({
  selector: 'app-estivage-centre-estivage-list-admin',
  templateUrl: './estivage-centre-estivage-list-admin.component.html',
  styleUrls: ['./estivage-centre-estivage-list-admin.component.css']
})
export class EstivageCentreEstivageListAdminComponent implements OnInit {
   // declarations
