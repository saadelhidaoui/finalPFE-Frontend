...
@Component({
  selector: 'app-estivage-centre-estivage-create-admin',
  templateUrl: './estivage-centre-estivage-create-admin.component.html',
  styleUrls: ['./estivage-centre-estivage-create-admin.component.css']
})
export class EstivageCentreEstivageCreateAdminComponent implements OnInit {
