...
@Component({
  selector: 'app-estivage-centre-estivage-edit-admin',
  templateUrl: './estivage-centre-estivage-edit-admin.component.html',
  styleUrls: ['./estivage-centre-estivage-edit-admin.component.css']
})
export class EstivageCentreEstivageEditAdminComponent implements OnInit {
