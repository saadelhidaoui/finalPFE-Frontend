...
import { FondationChercheurModule } from './view/Fondation/Fondation-chercheur.module';
import { FondationChercheurRoutingModule } from './view/Fondation/Fondation-chercheur-routing.module';
...
@NgModule({
  ...
  imports: [
    ...
    BadgeModule,
    MultiSelectModule,
  FondationChercheurModule,
  FondationChercheurRoutingModule,
  ],
  exports: [
  LoginChercheurComponent,
  RegisterChercheurComponent,
