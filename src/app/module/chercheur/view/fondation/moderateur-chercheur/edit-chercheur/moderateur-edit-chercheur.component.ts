...
@Component({
  selector: 'app-moderateur-edit-chercheur',
  templateUrl: './moderateur-edit-chercheur.component.html',
  styleUrls: ['./moderateur-edit-chercheur.component.css']
})
export class ModerateurEditChercheurComponent implements OnInit {
