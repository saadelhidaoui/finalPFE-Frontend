...
@Component({
  selector: 'app-moderateur-create-chercheur',
  templateUrl: './moderateur-create-chercheur.component.html',
  styleUrls: ['./moderateur-create-chercheur.component.css']
})
export class ModerateurCreateChercheurComponent implements OnInit {
