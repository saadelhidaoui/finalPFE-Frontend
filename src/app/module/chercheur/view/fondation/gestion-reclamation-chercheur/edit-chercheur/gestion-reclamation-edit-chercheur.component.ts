...
@Component({
  selector: 'app-gestion-reclamation-edit-chercheur',
  templateUrl: './gestion-reclamation-edit-chercheur.component.html',
  styleUrls: ['./gestion-reclamation-edit-chercheur.component.css']
})
export class GestionReclamationEditChercheurComponent implements OnInit {
