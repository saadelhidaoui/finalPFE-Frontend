...
@Component({
  selector: 'app-gestion-reclamation-create-chercheur',
  templateUrl: './gestion-reclamation-create-chercheur.component.html',
  styleUrls: ['./gestion-reclamation-create-chercheur.component.css']
})
export class GestionReclamationCreateChercheurComponent implements OnInit {
