...
@Component({
  selector: 'app-gestion-reclamation-list-chercheur',
  templateUrl: './gestion-reclamation-list-chercheur.component.html',
  styleUrls: ['./gestion-reclamation-list-chercheur.component.css']
})
export class GestionReclamationListChercheurComponent implements OnInit {
   // declarations
