...
@Component({
  selector: 'app-impression-carte-edit-chercheur',
  templateUrl: './impression-carte-edit-chercheur.component.html',
  styleUrls: ['./impression-carte-edit-chercheur.component.css']
})
export class ImpressionCarteEditChercheurComponent implements OnInit {
