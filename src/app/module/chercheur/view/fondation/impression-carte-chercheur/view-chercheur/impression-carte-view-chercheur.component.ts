...
@Component({
  selector: 'app-impression-carte-view-chercheur',
  templateUrl: './impression-carte-view-chercheur.component.html',
  styleUrls: ['./impression-carte-view-chercheur.component.css']
})
export class ImpressionCarteViewChercheurComponent implements OnInit {
