...
@Component({
  selector: 'app-fonction-view-chercheur',
  templateUrl: './fonction-view-chercheur.component.html',
  styleUrls: ['./fonction-view-chercheur.component.css']
})
export class FonctionViewChercheurComponent implements OnInit {
