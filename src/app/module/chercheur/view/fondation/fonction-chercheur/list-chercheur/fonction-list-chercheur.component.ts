...
@Component({
  selector: 'app-fonction-list-chercheur',
  templateUrl: './fonction-list-chercheur.component.html',
  styleUrls: ['./fonction-list-chercheur.component.css']
})
export class FonctionListChercheurComponent implements OnInit {
   // declarations
