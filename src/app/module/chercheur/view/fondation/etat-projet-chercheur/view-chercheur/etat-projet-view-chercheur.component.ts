...
@Component({
  selector: 'app-etat-projet-view-chercheur',
  templateUrl: './etat-projet-view-chercheur.component.html',
  styleUrls: ['./etat-projet-view-chercheur.component.css']
})
export class EtatProjetViewChercheurComponent implements OnInit {
