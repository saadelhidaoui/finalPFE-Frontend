...
@Component({
  selector: 'app-etat-projet-edit-chercheur',
  templateUrl: './etat-projet-edit-chercheur.component.html',
  styleUrls: ['./etat-projet-edit-chercheur.component.css']
})
export class EtatProjetEditChercheurComponent implements OnInit {
