...
@Component({
  selector: 'app-etat-projet-create-chercheur',
  templateUrl: './etat-projet-create-chercheur.component.html',
  styleUrls: ['./etat-projet-create-chercheur.component.css']
})
export class EtatProjetCreateChercheurComponent implements OnInit {
