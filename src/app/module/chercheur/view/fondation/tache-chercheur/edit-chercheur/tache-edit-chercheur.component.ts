...
@Component({
  selector: 'app-tache-edit-chercheur',
  templateUrl: './tache-edit-chercheur.component.html',
  styleUrls: ['./tache-edit-chercheur.component.css']
})
export class TacheEditChercheurComponent implements OnInit {
