...
@Component({
  selector: 'app-tache-list-chercheur',
  templateUrl: './tache-list-chercheur.component.html',
  styleUrls: ['./tache-list-chercheur.component.css']
})
export class TacheListChercheurComponent implements OnInit {
   // declarations
