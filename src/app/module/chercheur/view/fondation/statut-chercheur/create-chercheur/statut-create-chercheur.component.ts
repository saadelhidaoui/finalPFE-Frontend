...
@Component({
  selector: 'app-statut-create-chercheur',
  templateUrl: './statut-create-chercheur.component.html',
  styleUrls: ['./statut-create-chercheur.component.css']
})
export class StatutCreateChercheurComponent implements OnInit {
