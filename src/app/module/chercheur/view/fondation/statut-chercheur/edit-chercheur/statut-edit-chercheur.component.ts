...
@Component({
  selector: 'app-statut-edit-chercheur',
  templateUrl: './statut-edit-chercheur.component.html',
  styleUrls: ['./statut-edit-chercheur.component.css']
})
export class StatutEditChercheurComponent implements OnInit {
