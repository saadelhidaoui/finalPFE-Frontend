...
@Component({
  selector: 'app-statut-list-chercheur',
  templateUrl: './statut-list-chercheur.component.html',
  styleUrls: ['./statut-list-chercheur.component.css']
})
export class StatutListChercheurComponent implements OnInit {
   // declarations
