...
@Component({
  selector: 'app-statut-view-chercheur',
  templateUrl: './statut-view-chercheur.component.html',
  styleUrls: ['./statut-view-chercheur.component.css']
})
export class StatutViewChercheurComponent implements OnInit {
