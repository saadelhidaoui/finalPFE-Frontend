...
@Component({
  selector: 'app-piece-jointe-reclamation-list-chercheur',
  templateUrl: './piece-jointe-reclamation-list-chercheur.component.html',
  styleUrls: ['./piece-jointe-reclamation-list-chercheur.component.css']
})
export class PieceJointeReclamationListChercheurComponent implements OnInit {
   // declarations
