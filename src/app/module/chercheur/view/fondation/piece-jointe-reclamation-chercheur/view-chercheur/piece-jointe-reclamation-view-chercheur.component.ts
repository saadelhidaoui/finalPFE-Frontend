...
@Component({
  selector: 'app-piece-jointe-reclamation-view-chercheur',
  templateUrl: './piece-jointe-reclamation-view-chercheur.component.html',
  styleUrls: ['./piece-jointe-reclamation-view-chercheur.component.css']
})
export class PieceJointeReclamationViewChercheurComponent implements OnInit {
