...
@Component({
  selector: 'app-piece-jointe-reclamation-create-chercheur',
  templateUrl: './piece-jointe-reclamation-create-chercheur.component.html',
  styleUrls: ['./piece-jointe-reclamation-create-chercheur.component.css']
})
export class PieceJointeReclamationCreateChercheurComponent implements OnInit {
