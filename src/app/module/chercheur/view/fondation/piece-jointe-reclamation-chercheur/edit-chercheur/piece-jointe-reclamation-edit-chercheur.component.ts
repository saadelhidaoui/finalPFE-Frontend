...
@Component({
  selector: 'app-piece-jointe-reclamation-edit-chercheur',
  templateUrl: './piece-jointe-reclamation-edit-chercheur.component.html',
  styleUrls: ['./piece-jointe-reclamation-edit-chercheur.component.css']
})
export class PieceJointeReclamationEditChercheurComponent implements OnInit {
