...
@Component({
  selector: 'app-adherent-edit-chercheur',
  templateUrl: './adherent-edit-chercheur.component.html',
  styleUrls: ['./adherent-edit-chercheur.component.css']
})
export class AdherentEditChercheurComponent implements OnInit {
