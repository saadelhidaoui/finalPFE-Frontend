...
@Component({
  selector: 'app-adherent-list-chercheur',
  templateUrl: './adherent-list-chercheur.component.html',
  styleUrls: ['./adherent-list-chercheur.component.css']
})
export class AdherentListChercheurComponent implements OnInit {
   // declarations
