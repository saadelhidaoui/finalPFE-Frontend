...
@Component({
  selector: 'app-piece-jointe-projet-list-chercheur',
  templateUrl: './piece-jointe-projet-list-chercheur.component.html',
  styleUrls: ['./piece-jointe-projet-list-chercheur.component.css']
})
export class PieceJointeProjetListChercheurComponent implements OnInit {
   // declarations
