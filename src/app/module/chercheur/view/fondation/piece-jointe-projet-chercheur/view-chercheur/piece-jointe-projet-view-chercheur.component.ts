...
@Component({
  selector: 'app-piece-jointe-projet-view-chercheur',
  templateUrl: './piece-jointe-projet-view-chercheur.component.html',
  styleUrls: ['./piece-jointe-projet-view-chercheur.component.css']
})
export class PieceJointeProjetViewChercheurComponent implements OnInit {
