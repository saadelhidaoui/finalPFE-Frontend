...
@Component({
  selector: 'app-projet-list-chercheur',
  templateUrl: './projet-list-chercheur.component.html',
  styleUrls: ['./projet-list-chercheur.component.css']
})
export class ProjetListChercheurComponent implements OnInit {
   // declarations
