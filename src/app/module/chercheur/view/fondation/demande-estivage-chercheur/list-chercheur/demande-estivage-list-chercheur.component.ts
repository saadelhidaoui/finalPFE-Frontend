...
@Component({
  selector: 'app-demande-estivage-list-chercheur',
  templateUrl: './demande-estivage-list-chercheur.component.html',
  styleUrls: ['./demande-estivage-list-chercheur.component.css']
})
export class DemandeEstivageListChercheurComponent implements OnInit {
   // declarations
