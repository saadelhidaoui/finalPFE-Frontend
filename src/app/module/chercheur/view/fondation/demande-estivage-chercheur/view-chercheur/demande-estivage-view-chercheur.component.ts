...
@Component({
  selector: 'app-demande-estivage-view-chercheur',
  templateUrl: './demande-estivage-view-chercheur.component.html',
  styleUrls: ['./demande-estivage-view-chercheur.component.css']
})
export class DemandeEstivageViewChercheurComponent implements OnInit {
