...
@Component({
  selector: 'app-mission-view-chercheur',
  templateUrl: './mission-view-chercheur.component.html',
  styleUrls: ['./mission-view-chercheur.component.css']
})
export class MissionViewChercheurComponent implements OnInit {
