...
@Component({
  selector: 'app-qualite-create-chercheur',
  templateUrl: './qualite-create-chercheur.component.html',
  styleUrls: ['./qualite-create-chercheur.component.css']
})
export class QualiteCreateChercheurComponent implements OnInit {
