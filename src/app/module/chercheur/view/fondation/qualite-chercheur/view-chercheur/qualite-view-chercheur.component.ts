...
@Component({
  selector: 'app-qualite-view-chercheur',
  templateUrl: './qualite-view-chercheur.component.html',
  styleUrls: ['./qualite-view-chercheur.component.css']
})
export class QualiteViewChercheurComponent implements OnInit {
