...
@Component({
  selector: 'app-qualite-list-chercheur',
  templateUrl: './qualite-list-chercheur.component.html',
  styleUrls: ['./qualite-list-chercheur.component.css']
})
export class QualiteListChercheurComponent implements OnInit {
   // declarations
