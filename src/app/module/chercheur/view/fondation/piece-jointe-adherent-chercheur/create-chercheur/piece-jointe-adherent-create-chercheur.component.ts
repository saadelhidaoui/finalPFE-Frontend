...
@Component({
  selector: 'app-piece-jointe-adherent-create-chercheur',
  templateUrl: './piece-jointe-adherent-create-chercheur.component.html',
  styleUrls: ['./piece-jointe-adherent-create-chercheur.component.css']
})
export class PieceJointeAdherentCreateChercheurComponent implements OnInit {
