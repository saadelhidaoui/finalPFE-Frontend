...
@Component({
  selector: 'app-piece-jointe-adherent-view-chercheur',
  templateUrl: './piece-jointe-adherent-view-chercheur.component.html',
  styleUrls: ['./piece-jointe-adherent-view-chercheur.component.css']
})
export class PieceJointeAdherentViewChercheurComponent implements OnInit {
