...
@Component({
  selector: 'app-piece-jointe-adherent-list-chercheur',
  templateUrl: './piece-jointe-adherent-list-chercheur.component.html',
  styleUrls: ['./piece-jointe-adherent-list-chercheur.component.css']
})
export class PieceJointeAdherentListChercheurComponent implements OnInit {
   // declarations
