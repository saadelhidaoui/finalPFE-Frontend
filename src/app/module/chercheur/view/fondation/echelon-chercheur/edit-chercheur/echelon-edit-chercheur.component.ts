...
@Component({
  selector: 'app-echelon-edit-chercheur',
  templateUrl: './echelon-edit-chercheur.component.html',
  styleUrls: ['./echelon-edit-chercheur.component.css']
})
export class EchelonEditChercheurComponent implements OnInit {
