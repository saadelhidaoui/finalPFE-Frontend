...
@Component({
  selector: 'app-niveau-importance-list-chercheur',
  templateUrl: './niveau-importance-list-chercheur.component.html',
  styleUrls: ['./niveau-importance-list-chercheur.component.css']
})
export class NiveauImportanceListChercheurComponent implements OnInit {
   // declarations
