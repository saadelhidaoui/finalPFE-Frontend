...
@Component({
  selector: 'app-niveau-importance-edit-chercheur',
  templateUrl: './niveau-importance-edit-chercheur.component.html',
  styleUrls: ['./niveau-importance-edit-chercheur.component.css']
})
export class NiveauImportanceEditChercheurComponent implements OnInit {
