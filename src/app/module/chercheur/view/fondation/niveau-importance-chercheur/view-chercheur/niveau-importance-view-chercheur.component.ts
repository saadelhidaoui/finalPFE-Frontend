...
@Component({
  selector: 'app-niveau-importance-view-chercheur',
  templateUrl: './niveau-importance-view-chercheur.component.html',
  styleUrls: ['./niveau-importance-view-chercheur.component.css']
})
export class NiveauImportanceViewChercheurComponent implements OnInit {
