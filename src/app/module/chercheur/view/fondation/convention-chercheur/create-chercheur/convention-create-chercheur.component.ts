...
@Component({
  selector: 'app-convention-create-chercheur',
  templateUrl: './convention-create-chercheur.component.html',
  styleUrls: ['./convention-create-chercheur.component.css']
})
export class ConventionCreateChercheurComponent implements OnInit {
