...
@Component({
  selector: 'app-convention-list-chercheur',
  templateUrl: './convention-list-chercheur.component.html',
  styleUrls: ['./convention-list-chercheur.component.css']
})
export class ConventionListChercheurComponent implements OnInit {
   // declarations
