...
@Component({
  selector: 'app-convention-edit-chercheur',
  templateUrl: './convention-edit-chercheur.component.html',
  styleUrls: ['./convention-edit-chercheur.component.css']
})
export class ConventionEditChercheurComponent implements OnInit {
