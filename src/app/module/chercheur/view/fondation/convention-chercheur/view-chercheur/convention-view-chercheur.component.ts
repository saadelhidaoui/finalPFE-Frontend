...
@Component({
  selector: 'app-convention-view-chercheur',
  templateUrl: './convention-view-chercheur.component.html',
  styleUrls: ['./convention-view-chercheur.component.css']
})
export class ConventionViewChercheurComponent implements OnInit {
