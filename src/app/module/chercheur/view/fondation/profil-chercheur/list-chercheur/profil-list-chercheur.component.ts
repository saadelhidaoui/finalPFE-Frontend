...
@Component({
  selector: 'app-profil-list-chercheur',
  templateUrl: './profil-list-chercheur.component.html',
  styleUrls: ['./profil-list-chercheur.component.css']
})
export class ProfilListChercheurComponent implements OnInit {
   // declarations
