...
@Component({
  selector: 'app-profil-view-chercheur',
  templateUrl: './profil-view-chercheur.component.html',
  styleUrls: ['./profil-view-chercheur.component.css']
})
export class ProfilViewChercheurComponent implements OnInit {
