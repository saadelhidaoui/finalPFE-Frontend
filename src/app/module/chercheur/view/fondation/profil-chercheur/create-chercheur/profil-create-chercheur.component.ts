...
@Component({
  selector: 'app-profil-create-chercheur',
  templateUrl: './profil-create-chercheur.component.html',
  styleUrls: ['./profil-create-chercheur.component.css']
})
export class ProfilCreateChercheurComponent implements OnInit {
