...
@Component({
  selector: 'app-etat-carte-create-chercheur',
  templateUrl: './etat-carte-create-chercheur.component.html',
  styleUrls: ['./etat-carte-create-chercheur.component.css']
})
export class EtatCarteCreateChercheurComponent implements OnInit {
