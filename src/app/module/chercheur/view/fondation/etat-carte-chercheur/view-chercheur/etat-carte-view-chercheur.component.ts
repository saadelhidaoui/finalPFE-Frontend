...
@Component({
  selector: 'app-etat-carte-view-chercheur',
  templateUrl: './etat-carte-view-chercheur.component.html',
  styleUrls: ['./etat-carte-view-chercheur.component.css']
})
export class EtatCarteViewChercheurComponent implements OnInit {
