...
@Component({
  selector: 'app-etat-carte-list-chercheur',
  templateUrl: './etat-carte-list-chercheur.component.html',
  styleUrls: ['./etat-carte-list-chercheur.component.css']
})
export class EtatCarteListChercheurComponent implements OnInit {
   // declarations
