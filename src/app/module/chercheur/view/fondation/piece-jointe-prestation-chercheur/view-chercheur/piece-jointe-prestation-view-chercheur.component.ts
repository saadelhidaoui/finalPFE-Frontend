...
@Component({
  selector: 'app-piece-jointe-prestation-view-chercheur',
  templateUrl: './piece-jointe-prestation-view-chercheur.component.html',
  styleUrls: ['./piece-jointe-prestation-view-chercheur.component.css']
})
export class PieceJointePrestationViewChercheurComponent implements OnInit {
