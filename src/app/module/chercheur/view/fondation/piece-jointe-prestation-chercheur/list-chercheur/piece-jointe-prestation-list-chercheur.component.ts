...
@Component({
  selector: 'app-piece-jointe-prestation-list-chercheur',
  templateUrl: './piece-jointe-prestation-list-chercheur.component.html',
  styleUrls: ['./piece-jointe-prestation-list-chercheur.component.css']
})
export class PieceJointePrestationListChercheurComponent implements OnInit {
   // declarations
