...
@Component({
  selector: 'app-enfant-view-chercheur',
  templateUrl: './enfant-view-chercheur.component.html',
  styleUrls: ['./enfant-view-chercheur.component.css']
})
export class EnfantViewChercheurComponent implements OnInit {
