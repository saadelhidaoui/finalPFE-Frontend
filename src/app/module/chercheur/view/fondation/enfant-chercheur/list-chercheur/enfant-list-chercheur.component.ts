...
@Component({
  selector: 'app-enfant-list-chercheur',
  templateUrl: './enfant-list-chercheur.component.html',
  styleUrls: ['./enfant-list-chercheur.component.css']
})
export class EnfantListChercheurComponent implements OnInit {
   // declarations
