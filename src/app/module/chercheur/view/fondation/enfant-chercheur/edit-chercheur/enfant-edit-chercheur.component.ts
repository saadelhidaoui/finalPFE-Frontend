...
@Component({
  selector: 'app-enfant-edit-chercheur',
  templateUrl: './enfant-edit-chercheur.component.html',
  styleUrls: ['./enfant-edit-chercheur.component.css']
})
export class EnfantEditChercheurComponent implements OnInit {
