...
@Component({
  selector: 'app-type-prestation-edit-chercheur',
  templateUrl: './type-prestation-edit-chercheur.component.html',
  styleUrls: ['./type-prestation-edit-chercheur.component.css']
})
export class TypePrestationEditChercheurComponent implements OnInit {
