...
@Component({
  selector: 'app-type-prestation-create-chercheur',
  templateUrl: './type-prestation-create-chercheur.component.html',
  styleUrls: ['./type-prestation-create-chercheur.component.css']
})
export class TypePrestationCreateChercheurComponent implements OnInit {
