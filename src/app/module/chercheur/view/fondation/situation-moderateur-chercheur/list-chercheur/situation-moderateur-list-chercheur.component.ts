...
@Component({
  selector: 'app-situation-moderateur-list-chercheur',
  templateUrl: './situation-moderateur-list-chercheur.component.html',
  styleUrls: ['./situation-moderateur-list-chercheur.component.css']
})
export class SituationModerateurListChercheurComponent implements OnInit {
   // declarations
