...
@Component({
  selector: 'app-situation-moderateur-create-chercheur',
  templateUrl: './situation-moderateur-create-chercheur.component.html',
  styleUrls: ['./situation-moderateur-create-chercheur.component.css']
})
export class SituationModerateurCreateChercheurComponent implements OnInit {
