...
@Component({
  selector: 'app-situation-moderateur-edit-chercheur',
  templateUrl: './situation-moderateur-edit-chercheur.component.html',
  styleUrls: ['./situation-moderateur-edit-chercheur.component.css']
})
export class SituationModerateurEditChercheurComponent implements OnInit {
