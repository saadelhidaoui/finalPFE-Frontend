...
@Component({
  selector: 'app-etat-prestation-edit-chercheur',
  templateUrl: './etat-prestation-edit-chercheur.component.html',
  styleUrls: ['./etat-prestation-edit-chercheur.component.css']
})
export class EtatPrestationEditChercheurComponent implements OnInit {
