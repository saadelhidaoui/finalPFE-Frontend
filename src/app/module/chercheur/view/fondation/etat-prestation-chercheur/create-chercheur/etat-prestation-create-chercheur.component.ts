...
@Component({
  selector: 'app-etat-prestation-create-chercheur',
  templateUrl: './etat-prestation-create-chercheur.component.html',
  styleUrls: ['./etat-prestation-create-chercheur.component.css']
})
export class EtatPrestationCreateChercheurComponent implements OnInit {
