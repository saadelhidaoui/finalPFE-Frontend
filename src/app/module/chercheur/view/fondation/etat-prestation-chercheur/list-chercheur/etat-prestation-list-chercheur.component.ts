...
@Component({
  selector: 'app-etat-prestation-list-chercheur',
  templateUrl: './etat-prestation-list-chercheur.component.html',
  styleUrls: ['./etat-prestation-list-chercheur.component.css']
})
export class EtatPrestationListChercheurComponent implements OnInit {
   // declarations
