...
@Component({
  selector: 'app-organisme-list-chercheur',
  templateUrl: './organisme-list-chercheur.component.html',
  styleUrls: ['./organisme-list-chercheur.component.css']
})
export class OrganismeListChercheurComponent implements OnInit {
   // declarations
