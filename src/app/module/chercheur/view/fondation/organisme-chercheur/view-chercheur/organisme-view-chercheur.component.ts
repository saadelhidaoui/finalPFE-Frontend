...
@Component({
  selector: 'app-organisme-view-chercheur',
  templateUrl: './organisme-view-chercheur.component.html',
  styleUrls: ['./organisme-view-chercheur.component.css']
})
export class OrganismeViewChercheurComponent implements OnInit {
