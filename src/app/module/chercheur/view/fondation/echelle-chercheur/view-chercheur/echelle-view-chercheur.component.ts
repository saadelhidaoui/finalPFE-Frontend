...
@Component({
  selector: 'app-echelle-view-chercheur',
  templateUrl: './echelle-view-chercheur.component.html',
  styleUrls: ['./echelle-view-chercheur.component.css']
})
export class EchelleViewChercheurComponent implements OnInit {
