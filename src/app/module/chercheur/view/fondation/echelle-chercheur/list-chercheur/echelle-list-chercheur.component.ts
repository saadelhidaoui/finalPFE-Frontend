...
@Component({
  selector: 'app-echelle-list-chercheur',
  templateUrl: './echelle-list-chercheur.component.html',
  styleUrls: ['./echelle-list-chercheur.component.css']
})
export class EchelleListChercheurComponent implements OnInit {
   // declarations
