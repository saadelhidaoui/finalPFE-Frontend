...
@Component({
  selector: 'app-echelle-create-chercheur',
  templateUrl: './echelle-create-chercheur.component.html',
  styleUrls: ['./echelle-create-chercheur.component.css']
})
export class EchelleCreateChercheurComponent implements OnInit {
