...
@Component({
  selector: 'app-piece-jointe-produit-view-chercheur',
  templateUrl: './piece-jointe-produit-view-chercheur.component.html',
  styleUrls: ['./piece-jointe-produit-view-chercheur.component.css']
})
export class PieceJointeProduitViewChercheurComponent implements OnInit {
