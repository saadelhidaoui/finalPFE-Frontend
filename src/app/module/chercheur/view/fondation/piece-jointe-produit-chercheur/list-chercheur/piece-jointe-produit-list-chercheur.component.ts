...
@Component({
  selector: 'app-piece-jointe-produit-list-chercheur',
  templateUrl: './piece-jointe-produit-list-chercheur.component.html',
  styleUrls: ['./piece-jointe-produit-list-chercheur.component.css']
})
export class PieceJointeProduitListChercheurComponent implements OnInit {
   // declarations
