...
@Component({
  selector: 'app-prestation-edit-chercheur',
  templateUrl: './prestation-edit-chercheur.component.html',
  styleUrls: ['./prestation-edit-chercheur.component.css']
})
export class PrestationEditChercheurComponent implements OnInit {
