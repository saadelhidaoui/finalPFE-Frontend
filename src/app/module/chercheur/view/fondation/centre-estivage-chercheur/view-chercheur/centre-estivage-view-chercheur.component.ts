...
@Component({
  selector: 'app-centre-estivage-view-chercheur',
  templateUrl: './centre-estivage-view-chercheur.component.html',
  styleUrls: ['./centre-estivage-view-chercheur.component.css']
})
export class CentreEstivageViewChercheurComponent implements OnInit {
