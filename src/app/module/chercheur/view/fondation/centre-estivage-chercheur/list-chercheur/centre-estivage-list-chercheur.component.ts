...
@Component({
  selector: 'app-centre-estivage-list-chercheur',
  templateUrl: './centre-estivage-list-chercheur.component.html',
  styleUrls: ['./centre-estivage-list-chercheur.component.css']
})
export class CentreEstivageListChercheurComponent implements OnInit {
   // declarations
