...
@Component({
  selector: 'app-estivage-centre-estivage-view-chercheur',
  templateUrl: './estivage-centre-estivage-view-chercheur.component.html',
  styleUrls: ['./estivage-centre-estivage-view-chercheur.component.css']
})
export class EstivageCentreEstivageViewChercheurComponent implements OnInit {
