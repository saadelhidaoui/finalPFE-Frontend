...
@Component({
  selector: 'app-estivage-centre-estivage-create-chercheur',
  templateUrl: './estivage-centre-estivage-create-chercheur.component.html',
  styleUrls: ['./estivage-centre-estivage-create-chercheur.component.css']
})
export class EstivageCentreEstivageCreateChercheurComponent implements OnInit {
