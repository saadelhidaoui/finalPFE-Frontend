...
@Component({
  selector: 'app-estivage-centre-estivage-edit-chercheur',
  templateUrl: './estivage-centre-estivage-edit-chercheur.component.html',
  styleUrls: ['./estivage-centre-estivage-edit-chercheur.component.css']
})
export class EstivageCentreEstivageEditChercheurComponent implements OnInit {
