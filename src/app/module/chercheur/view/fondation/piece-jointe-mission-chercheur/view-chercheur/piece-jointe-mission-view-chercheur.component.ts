...
@Component({
  selector: 'app-piece-jointe-mission-view-chercheur',
  templateUrl: './piece-jointe-mission-view-chercheur.component.html',
  styleUrls: ['./piece-jointe-mission-view-chercheur.component.css']
})
export class PieceJointeMissionViewChercheurComponent implements OnInit {
