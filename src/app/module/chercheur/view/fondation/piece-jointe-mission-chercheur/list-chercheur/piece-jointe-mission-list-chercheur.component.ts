...
@Component({
  selector: 'app-piece-jointe-mission-list-chercheur',
  templateUrl: './piece-jointe-mission-list-chercheur.component.html',
  styleUrls: ['./piece-jointe-mission-list-chercheur.component.css']
})
export class PieceJointeMissionListChercheurComponent implements OnInit {
   // declarations
