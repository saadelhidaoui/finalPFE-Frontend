...
@Component({
  selector: 'app-conjoint-list-chercheur',
  templateUrl: './conjoint-list-chercheur.component.html',
  styleUrls: ['./conjoint-list-chercheur.component.css']
})
export class ConjointListChercheurComponent implements OnInit {
   // declarations
