...
@Component({
  selector: 'app-etat-tache-list-chercheur',
  templateUrl: './etat-tache-list-chercheur.component.html',
  styleUrls: ['./etat-tache-list-chercheur.component.css']
})
export class EtatTacheListChercheurComponent implements OnInit {
   // declarations
