...
@Component({
  selector: 'app-etat-tache-view-chercheur',
  templateUrl: './etat-tache-view-chercheur.component.html',
  styleUrls: ['./etat-tache-view-chercheur.component.css']
})
export class EtatTacheViewChercheurComponent implements OnInit {
