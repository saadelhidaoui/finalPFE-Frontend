...
@Component({
  selector: 'app-etat-tache-edit-chercheur',
  templateUrl: './etat-tache-edit-chercheur.component.html',
  styleUrls: ['./etat-tache-edit-chercheur.component.css']
})
export class EtatTacheEditChercheurComponent implements OnInit {
