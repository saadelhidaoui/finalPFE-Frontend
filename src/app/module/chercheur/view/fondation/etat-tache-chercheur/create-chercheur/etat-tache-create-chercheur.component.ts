...
@Component({
  selector: 'app-etat-tache-create-chercheur',
  templateUrl: './etat-tache-create-chercheur.component.html',
  styleUrls: ['./etat-tache-create-chercheur.component.css']
})
export class EtatTacheCreateChercheurComponent implements OnInit {
