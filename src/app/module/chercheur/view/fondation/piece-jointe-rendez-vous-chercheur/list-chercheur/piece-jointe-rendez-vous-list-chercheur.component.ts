...
@Component({
  selector: 'app-piece-jointe-rendez-vous-list-chercheur',
  templateUrl: './piece-jointe-rendez-vous-list-chercheur.component.html',
  styleUrls: ['./piece-jointe-rendez-vous-list-chercheur.component.css']
})
export class PieceJointeRendezVousListChercheurComponent implements OnInit {
   // declarations
