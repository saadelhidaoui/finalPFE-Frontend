...
@Component({
  selector: 'app-etat-demande-estivage-list-chercheur',
  templateUrl: './etat-demande-estivage-list-chercheur.component.html',
  styleUrls: ['./etat-demande-estivage-list-chercheur.component.css']
})
export class EtatDemandeEstivageListChercheurComponent implements OnInit {
   // declarations
