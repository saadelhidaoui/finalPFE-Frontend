...
@Component({
  selector: 'app-etat-demande-estivage-view-chercheur',
  templateUrl: './etat-demande-estivage-view-chercheur.component.html',
  styleUrls: ['./etat-demande-estivage-view-chercheur.component.css']
})
export class EtatDemandeEstivageViewChercheurComponent implements OnInit {
