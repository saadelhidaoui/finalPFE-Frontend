...
@Component({
  selector: 'app-estivage-list-chercheur',
  templateUrl: './estivage-list-chercheur.component.html',
  styleUrls: ['./estivage-list-chercheur.component.css']
})
export class EstivageListChercheurComponent implements OnInit {
   // declarations
