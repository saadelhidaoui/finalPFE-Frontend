...
@Component({
  selector: 'app-estivage-view-chercheur',
  templateUrl: './estivage-view-chercheur.component.html',
  styleUrls: ['./estivage-view-chercheur.component.css']
})
export class EstivageViewChercheurComponent implements OnInit {
