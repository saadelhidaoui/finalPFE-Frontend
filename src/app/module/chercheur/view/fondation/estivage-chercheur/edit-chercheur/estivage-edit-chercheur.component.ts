...
@Component({
  selector: 'app-estivage-edit-chercheur',
  templateUrl: './estivage-edit-chercheur.component.html',
  styleUrls: ['./estivage-edit-chercheur.component.css']
})
export class EstivageEditChercheurComponent implements OnInit {
