...
@Component({
  selector: 'app-demande-estivage-centre-edit-chercheur',
  templateUrl: './demande-estivage-centre-edit-chercheur.component.html',
  styleUrls: ['./demande-estivage-centre-edit-chercheur.component.css']
})
export class DemandeEstivageCentreEditChercheurComponent implements OnInit {
