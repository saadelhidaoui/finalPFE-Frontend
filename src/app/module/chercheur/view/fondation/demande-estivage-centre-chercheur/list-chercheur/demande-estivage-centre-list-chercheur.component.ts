...
@Component({
  selector: 'app-demande-estivage-centre-list-chercheur',
  templateUrl: './demande-estivage-centre-list-chercheur.component.html',
  styleUrls: ['./demande-estivage-centre-list-chercheur.component.css']
})
export class DemandeEstivageCentreListChercheurComponent implements OnInit {
   // declarations
