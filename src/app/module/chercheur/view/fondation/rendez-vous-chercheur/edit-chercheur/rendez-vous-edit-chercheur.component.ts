...
@Component({
  selector: 'app-rendez-vous-edit-chercheur',
  templateUrl: './rendez-vous-edit-chercheur.component.html',
  styleUrls: ['./rendez-vous-edit-chercheur.component.css']
})
export class RendezVousEditChercheurComponent implements OnInit {
