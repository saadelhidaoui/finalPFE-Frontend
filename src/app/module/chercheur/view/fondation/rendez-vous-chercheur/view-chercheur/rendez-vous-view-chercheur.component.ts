...
@Component({
  selector: 'app-rendez-vous-view-chercheur',
  templateUrl: './rendez-vous-view-chercheur.component.html',
  styleUrls: ['./rendez-vous-view-chercheur.component.css']
})
export class RendezVousViewChercheurComponent implements OnInit {
