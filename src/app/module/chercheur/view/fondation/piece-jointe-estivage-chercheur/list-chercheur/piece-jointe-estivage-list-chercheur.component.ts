...
@Component({
  selector: 'app-piece-jointe-estivage-list-chercheur',
  templateUrl: './piece-jointe-estivage-list-chercheur.component.html',
  styleUrls: ['./piece-jointe-estivage-list-chercheur.component.css']
})
export class PieceJointeEstivageListChercheurComponent implements OnInit {
   // declarations
