...
@Component({
  selector: 'app-piece-jointe-estivage-view-chercheur',
  templateUrl: './piece-jointe-estivage-view-chercheur.component.html',
  styleUrls: ['./piece-jointe-estivage-view-chercheur.component.css']
})
export class PieceJointeEstivageViewChercheurComponent implements OnInit {
