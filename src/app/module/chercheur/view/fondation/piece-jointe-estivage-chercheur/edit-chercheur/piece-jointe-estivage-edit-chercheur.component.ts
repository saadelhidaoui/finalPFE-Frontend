...
@Component({
  selector: 'app-piece-jointe-estivage-edit-chercheur',
  templateUrl: './piece-jointe-estivage-edit-chercheur.component.html',
  styleUrls: ['./piece-jointe-estivage-edit-chercheur.component.css']
})
export class PieceJointeEstivageEditChercheurComponent implements OnInit {
