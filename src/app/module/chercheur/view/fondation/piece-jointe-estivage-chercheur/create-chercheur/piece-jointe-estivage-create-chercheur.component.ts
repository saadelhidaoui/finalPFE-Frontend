...
@Component({
  selector: 'app-piece-jointe-estivage-create-chercheur',
  templateUrl: './piece-jointe-estivage-create-chercheur.component.html',
  styleUrls: ['./piece-jointe-estivage-create-chercheur.component.css']
})
export class PieceJointeEstivageCreateChercheurComponent implements OnInit {
