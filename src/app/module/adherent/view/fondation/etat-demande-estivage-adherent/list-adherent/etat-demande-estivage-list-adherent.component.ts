...
@Component({
  selector: 'app-etat-demande-estivage-list-adherent',
  templateUrl: './etat-demande-estivage-list-adherent.component.html',
  styleUrls: ['./etat-demande-estivage-list-adherent.component.css']
})
export class EtatDemandeEstivageListAdherentComponent implements OnInit {
   // declarations
