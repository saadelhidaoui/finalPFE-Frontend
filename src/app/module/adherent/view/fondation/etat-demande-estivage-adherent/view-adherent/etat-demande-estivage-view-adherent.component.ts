...
@Component({
  selector: 'app-etat-demande-estivage-view-adherent',
  templateUrl: './etat-demande-estivage-view-adherent.component.html',
  styleUrls: ['./etat-demande-estivage-view-adherent.component.css']
})
export class EtatDemandeEstivageViewAdherentComponent implements OnInit {
