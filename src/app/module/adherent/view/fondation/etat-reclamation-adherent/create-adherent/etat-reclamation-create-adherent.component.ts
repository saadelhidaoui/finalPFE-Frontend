...
@Component({
  selector: 'app-etat-reclamation-create-adherent',
  templateUrl: './etat-reclamation-create-adherent.component.html',
  styleUrls: ['./etat-reclamation-create-adherent.component.css']
})
export class EtatReclamationCreateAdherentComponent implements OnInit {
