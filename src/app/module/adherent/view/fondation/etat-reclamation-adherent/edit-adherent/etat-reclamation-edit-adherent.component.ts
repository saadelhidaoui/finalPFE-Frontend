...
@Component({
  selector: 'app-etat-reclamation-edit-adherent',
  templateUrl: './etat-reclamation-edit-adherent.component.html',
  styleUrls: ['./etat-reclamation-edit-adherent.component.css']
})
export class EtatReclamationEditAdherentComponent implements OnInit {
