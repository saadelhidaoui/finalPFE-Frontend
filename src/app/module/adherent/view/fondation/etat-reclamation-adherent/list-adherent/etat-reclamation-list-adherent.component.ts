...
@Component({
  selector: 'app-etat-reclamation-list-adherent',
  templateUrl: './etat-reclamation-list-adherent.component.html',
  styleUrls: ['./etat-reclamation-list-adherent.component.css']
})
export class EtatReclamationListAdherentComponent implements OnInit {
   // declarations
