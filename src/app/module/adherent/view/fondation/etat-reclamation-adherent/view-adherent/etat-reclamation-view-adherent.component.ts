...
@Component({
  selector: 'app-etat-reclamation-view-adherent',
  templateUrl: './etat-reclamation-view-adherent.component.html',
  styleUrls: ['./etat-reclamation-view-adherent.component.css']
})
export class EtatReclamationViewAdherentComponent implements OnInit {
