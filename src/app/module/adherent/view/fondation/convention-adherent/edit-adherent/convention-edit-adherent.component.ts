...
@Component({
  selector: 'app-convention-edit-adherent',
  templateUrl: './convention-edit-adherent.component.html',
  styleUrls: ['./convention-edit-adherent.component.css']
})
export class ConventionEditAdherentComponent implements OnInit {
