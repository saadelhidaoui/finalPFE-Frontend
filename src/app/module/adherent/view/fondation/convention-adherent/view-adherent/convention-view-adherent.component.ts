...
@Component({
  selector: 'app-convention-view-adherent',
  templateUrl: './convention-view-adherent.component.html',
  styleUrls: ['./convention-view-adherent.component.css']
})
export class ConventionViewAdherentComponent implements OnInit {
