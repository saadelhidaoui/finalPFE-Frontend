...
@Component({
  selector: 'app-convention-list-adherent',
  templateUrl: './convention-list-adherent.component.html',
  styleUrls: ['./convention-list-adherent.component.css']
})
export class ConventionListAdherentComponent implements OnInit {
   // declarations
