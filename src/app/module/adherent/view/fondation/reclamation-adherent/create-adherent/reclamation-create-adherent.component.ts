...
@Component({
  selector: 'app-reclamation-create-adherent',
  templateUrl: './reclamation-create-adherent.component.html',
  styleUrls: ['./reclamation-create-adherent.component.css']
})
export class ReclamationCreateAdherentComponent implements OnInit {
