...
@Component({
  selector: 'app-reclamation-list-adherent',
  templateUrl: './reclamation-list-adherent.component.html',
  styleUrls: ['./reclamation-list-adherent.component.css']
})
export class ReclamationListAdherentComponent implements OnInit {
   // declarations
