...
@Component({
  selector: 'app-reclamation-edit-adherent',
  templateUrl: './reclamation-edit-adherent.component.html',
  styleUrls: ['./reclamation-edit-adherent.component.css']
})
export class ReclamationEditAdherentComponent implements OnInit {
