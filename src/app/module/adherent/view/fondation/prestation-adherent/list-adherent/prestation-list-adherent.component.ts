...
@Component({
  selector: 'app-prestation-list-adherent',
  templateUrl: './prestation-list-adherent.component.html',
  styleUrls: ['./prestation-list-adherent.component.css']
})
export class PrestationListAdherentComponent implements OnInit {
   // declarations
