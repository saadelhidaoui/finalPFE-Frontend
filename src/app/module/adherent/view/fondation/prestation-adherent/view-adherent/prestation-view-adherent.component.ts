...
@Component({
  selector: 'app-prestation-view-adherent',
  templateUrl: './prestation-view-adherent.component.html',
  styleUrls: ['./prestation-view-adherent.component.css']
})
export class PrestationViewAdherentComponent implements OnInit {
