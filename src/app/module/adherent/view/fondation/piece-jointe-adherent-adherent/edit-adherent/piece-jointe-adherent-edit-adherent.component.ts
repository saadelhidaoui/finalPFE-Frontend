...
@Component({
  selector: 'app-piece-jointe-adherent-edit-adherent',
  templateUrl: './piece-jointe-adherent-edit-adherent.component.html',
  styleUrls: ['./piece-jointe-adherent-edit-adherent.component.css']
})
export class PieceJointeAdherentEditAdherentComponent implements OnInit {
