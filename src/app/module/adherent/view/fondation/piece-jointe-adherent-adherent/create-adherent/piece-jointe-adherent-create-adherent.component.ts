...
@Component({
  selector: 'app-piece-jointe-adherent-create-adherent',
  templateUrl: './piece-jointe-adherent-create-adherent.component.html',
  styleUrls: ['./piece-jointe-adherent-create-adherent.component.css']
})
export class PieceJointeAdherentCreateAdherentComponent implements OnInit {
