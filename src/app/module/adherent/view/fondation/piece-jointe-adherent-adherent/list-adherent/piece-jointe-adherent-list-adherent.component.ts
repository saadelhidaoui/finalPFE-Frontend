...
@Component({
  selector: 'app-piece-jointe-adherent-list-adherent',
  templateUrl: './piece-jointe-adherent-list-adherent.component.html',
  styleUrls: ['./piece-jointe-adherent-list-adherent.component.css']
})
export class PieceJointeAdherentListAdherentComponent implements OnInit {
   // declarations
