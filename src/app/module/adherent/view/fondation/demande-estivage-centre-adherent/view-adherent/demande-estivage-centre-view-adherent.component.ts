...
@Component({
  selector: 'app-demande-estivage-centre-view-adherent',
  templateUrl: './demande-estivage-centre-view-adherent.component.html',
  styleUrls: ['./demande-estivage-centre-view-adherent.component.css']
})
export class DemandeEstivageCentreViewAdherentComponent implements OnInit {
