...
@Component({
  selector: 'app-demande-estivage-centre-list-adherent',
  templateUrl: './demande-estivage-centre-list-adherent.component.html',
  styleUrls: ['./demande-estivage-centre-list-adherent.component.css']
})
export class DemandeEstivageCentreListAdherentComponent implements OnInit {
   // declarations
