...
@Component({
  selector: 'app-piece-jointe-prestation-view-adherent',
  templateUrl: './piece-jointe-prestation-view-adherent.component.html',
  styleUrls: ['./piece-jointe-prestation-view-adherent.component.css']
})
export class PieceJointePrestationViewAdherentComponent implements OnInit {
