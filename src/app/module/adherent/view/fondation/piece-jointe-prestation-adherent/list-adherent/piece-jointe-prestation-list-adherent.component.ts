...
@Component({
  selector: 'app-piece-jointe-prestation-list-adherent',
  templateUrl: './piece-jointe-prestation-list-adherent.component.html',
  styleUrls: ['./piece-jointe-prestation-list-adherent.component.css']
})
export class PieceJointePrestationListAdherentComponent implements OnInit {
   // declarations
