...
@Component({
  selector: 'app-situation-moderateur-edit-adherent',
  templateUrl: './situation-moderateur-edit-adherent.component.html',
  styleUrls: ['./situation-moderateur-edit-adherent.component.css']
})
export class SituationModerateurEditAdherentComponent implements OnInit {
