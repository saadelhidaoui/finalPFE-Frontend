...
@Component({
  selector: 'app-situation-moderateur-view-adherent',
  templateUrl: './situation-moderateur-view-adherent.component.html',
  styleUrls: ['./situation-moderateur-view-adherent.component.css']
})
export class SituationModerateurViewAdherentComponent implements OnInit {
