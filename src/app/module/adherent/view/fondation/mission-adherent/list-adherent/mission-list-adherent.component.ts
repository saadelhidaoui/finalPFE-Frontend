...
@Component({
  selector: 'app-mission-list-adherent',
  templateUrl: './mission-list-adherent.component.html',
  styleUrls: ['./mission-list-adherent.component.css']
})
export class MissionListAdherentComponent implements OnInit {
   // declarations
