...
@Component({
  selector: 'app-mission-view-adherent',
  templateUrl: './mission-view-adherent.component.html',
  styleUrls: ['./mission-view-adherent.component.css']
})
export class MissionViewAdherentComponent implements OnInit {
