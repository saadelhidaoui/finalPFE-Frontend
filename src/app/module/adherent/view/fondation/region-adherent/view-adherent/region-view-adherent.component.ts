...
@Component({
  selector: 'app-region-view-adherent',
  templateUrl: './region-view-adherent.component.html',
  styleUrls: ['./region-view-adherent.component.css']
})
export class RegionViewAdherentComponent implements OnInit {
