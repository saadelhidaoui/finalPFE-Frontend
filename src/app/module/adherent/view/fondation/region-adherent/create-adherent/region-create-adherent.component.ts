...
@Component({
  selector: 'app-region-create-adherent',
  templateUrl: './region-create-adherent.component.html',
  styleUrls: ['./region-create-adherent.component.css']
})
export class RegionCreateAdherentComponent implements OnInit {
