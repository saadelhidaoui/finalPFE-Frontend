...
@Component({
  selector: 'app-region-list-adherent',
  templateUrl: './region-list-adherent.component.html',
  styleUrls: ['./region-list-adherent.component.css']
})
export class RegionListAdherentComponent implements OnInit {
   // declarations
