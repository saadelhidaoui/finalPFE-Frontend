...
@Component({
  selector: 'app-region-edit-adherent',
  templateUrl: './region-edit-adherent.component.html',
  styleUrls: ['./region-edit-adherent.component.css']
})
export class RegionEditAdherentComponent implements OnInit {
