...
@Component({
  selector: 'app-adherent-view-adherent',
  templateUrl: './adherent-view-adherent.component.html',
  styleUrls: ['./adherent-view-adherent.component.css']
})
export class AdherentViewAdherentComponent implements OnInit {
