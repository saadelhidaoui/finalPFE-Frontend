...
@Component({
  selector: 'app-adherent-list-adherent',
  templateUrl: './adherent-list-adherent.component.html',
  styleUrls: ['./adherent-list-adherent.component.css']
})
export class AdherentListAdherentComponent implements OnInit {
   // declarations
