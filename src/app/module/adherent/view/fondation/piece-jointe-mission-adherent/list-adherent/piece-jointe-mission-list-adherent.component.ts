...
@Component({
  selector: 'app-piece-jointe-mission-list-adherent',
  templateUrl: './piece-jointe-mission-list-adherent.component.html',
  styleUrls: ['./piece-jointe-mission-list-adherent.component.css']
})
export class PieceJointeMissionListAdherentComponent implements OnInit {
   // declarations
