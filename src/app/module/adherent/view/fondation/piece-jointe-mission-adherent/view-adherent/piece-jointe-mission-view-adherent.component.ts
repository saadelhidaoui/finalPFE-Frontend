...
@Component({
  selector: 'app-piece-jointe-mission-view-adherent',
  templateUrl: './piece-jointe-mission-view-adherent.component.html',
  styleUrls: ['./piece-jointe-mission-view-adherent.component.css']
})
export class PieceJointeMissionViewAdherentComponent implements OnInit {
