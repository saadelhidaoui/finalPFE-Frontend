...
@Component({
  selector: 'app-rendez-vous-list-adherent',
  templateUrl: './rendez-vous-list-adherent.component.html',
  styleUrls: ['./rendez-vous-list-adherent.component.css']
})
export class RendezVousListAdherentComponent implements OnInit {
   // declarations
