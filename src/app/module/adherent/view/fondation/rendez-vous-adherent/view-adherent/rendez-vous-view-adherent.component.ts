...
@Component({
  selector: 'app-rendez-vous-view-adherent',
  templateUrl: './rendez-vous-view-adherent.component.html',
  styleUrls: ['./rendez-vous-view-adherent.component.css']
})
export class RendezVousViewAdherentComponent implements OnInit {
