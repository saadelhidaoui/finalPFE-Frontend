...
@Component({
  selector: 'app-rendez-vous-create-adherent',
  templateUrl: './rendez-vous-create-adherent.component.html',
  styleUrls: ['./rendez-vous-create-adherent.component.css']
})
export class RendezVousCreateAdherentComponent implements OnInit {
