...
@Component({
  selector: 'app-piece-jointe-reclamation-edit-adherent',
  templateUrl: './piece-jointe-reclamation-edit-adherent.component.html',
  styleUrls: ['./piece-jointe-reclamation-edit-adherent.component.css']
})
export class PieceJointeReclamationEditAdherentComponent implements OnInit {
