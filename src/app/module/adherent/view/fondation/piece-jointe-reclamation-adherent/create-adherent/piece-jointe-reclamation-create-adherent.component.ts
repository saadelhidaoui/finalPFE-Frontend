...
@Component({
  selector: 'app-piece-jointe-reclamation-create-adherent',
  templateUrl: './piece-jointe-reclamation-create-adherent.component.html',
  styleUrls: ['./piece-jointe-reclamation-create-adherent.component.css']
})
export class PieceJointeReclamationCreateAdherentComponent implements OnInit {
