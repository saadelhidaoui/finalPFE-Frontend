...
@Component({
  selector: 'app-piece-jointe-reclamation-list-adherent',
  templateUrl: './piece-jointe-reclamation-list-adherent.component.html',
  styleUrls: ['./piece-jointe-reclamation-list-adherent.component.css']
})
export class PieceJointeReclamationListAdherentComponent implements OnInit {
   // declarations
