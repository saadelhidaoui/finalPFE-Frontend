...
@Component({
  selector: 'app-grade-list-adherent',
  templateUrl: './grade-list-adherent.component.html',
  styleUrls: ['./grade-list-adherent.component.css']
})
export class GradeListAdherentComponent implements OnInit {
   // declarations
