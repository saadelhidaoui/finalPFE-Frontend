...
@Component({
  selector: 'app-grade-view-adherent',
  templateUrl: './grade-view-adherent.component.html',
  styleUrls: ['./grade-view-adherent.component.css']
})
export class GradeViewAdherentComponent implements OnInit {
