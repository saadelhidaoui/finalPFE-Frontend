...
@Component({
  selector: 'app-grade-edit-adherent',
  templateUrl: './grade-edit-adherent.component.html',
  styleUrls: ['./grade-edit-adherent.component.css']
})
export class GradeEditAdherentComponent implements OnInit {
