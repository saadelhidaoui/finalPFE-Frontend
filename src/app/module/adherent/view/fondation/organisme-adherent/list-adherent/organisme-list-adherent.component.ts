...
@Component({
  selector: 'app-organisme-list-adherent',
  templateUrl: './organisme-list-adherent.component.html',
  styleUrls: ['./organisme-list-adherent.component.css']
})
export class OrganismeListAdherentComponent implements OnInit {
   // declarations
