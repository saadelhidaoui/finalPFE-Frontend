...
@Component({
  selector: 'app-echelle-view-adherent',
  templateUrl: './echelle-view-adherent.component.html',
  styleUrls: ['./echelle-view-adherent.component.css']
})
export class EchelleViewAdherentComponent implements OnInit {
