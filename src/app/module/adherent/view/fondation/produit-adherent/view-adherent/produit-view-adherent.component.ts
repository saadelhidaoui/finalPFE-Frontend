...
@Component({
  selector: 'app-produit-view-adherent',
  templateUrl: './produit-view-adherent.component.html',
  styleUrls: ['./produit-view-adherent.component.css']
})
export class ProduitViewAdherentComponent implements OnInit {
