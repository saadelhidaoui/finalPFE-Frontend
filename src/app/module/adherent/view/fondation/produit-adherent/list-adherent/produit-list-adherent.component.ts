...
@Component({
  selector: 'app-produit-list-adherent',
  templateUrl: './produit-list-adherent.component.html',
  styleUrls: ['./produit-list-adherent.component.css']
})
export class ProduitListAdherentComponent implements OnInit {
   // declarations
