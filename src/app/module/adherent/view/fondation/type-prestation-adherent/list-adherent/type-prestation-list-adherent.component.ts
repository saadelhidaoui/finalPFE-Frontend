...
@Component({
  selector: 'app-type-prestation-list-adherent',
  templateUrl: './type-prestation-list-adherent.component.html',
  styleUrls: ['./type-prestation-list-adherent.component.css']
})
export class TypePrestationListAdherentComponent implements OnInit {
   // declarations
