...
@Component({
  selector: 'app-type-prestation-create-adherent',
  templateUrl: './type-prestation-create-adherent.component.html',
  styleUrls: ['./type-prestation-create-adherent.component.css']
})
export class TypePrestationCreateAdherentComponent implements OnInit {
