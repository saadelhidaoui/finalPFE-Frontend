...
@Component({
  selector: 'app-type-prestation-view-adherent',
  templateUrl: './type-prestation-view-adherent.component.html',
  styleUrls: ['./type-prestation-view-adherent.component.css']
})
export class TypePrestationViewAdherentComponent implements OnInit {
