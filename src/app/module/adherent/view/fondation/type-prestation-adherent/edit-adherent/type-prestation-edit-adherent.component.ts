...
@Component({
  selector: 'app-type-prestation-edit-adherent',
  templateUrl: './type-prestation-edit-adherent.component.html',
  styleUrls: ['./type-prestation-edit-adherent.component.css']
})
export class TypePrestationEditAdherentComponent implements OnInit {
