...
@Component({
  selector: 'app-profil-view-adherent',
  templateUrl: './profil-view-adherent.component.html',
  styleUrls: ['./profil-view-adherent.component.css']
})
export class ProfilViewAdherentComponent implements OnInit {
