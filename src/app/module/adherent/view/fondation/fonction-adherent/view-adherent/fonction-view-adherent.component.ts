...
@Component({
  selector: 'app-fonction-view-adherent',
  templateUrl: './fonction-view-adherent.component.html',
  styleUrls: ['./fonction-view-adherent.component.css']
})
export class FonctionViewAdherentComponent implements OnInit {
