...
@Component({
  selector: 'app-fonction-edit-adherent',
  templateUrl: './fonction-edit-adherent.component.html',
  styleUrls: ['./fonction-edit-adherent.component.css']
})
export class FonctionEditAdherentComponent implements OnInit {
