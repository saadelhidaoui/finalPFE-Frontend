...
@Component({
  selector: 'app-estivage-centre-estivage-list-adherent',
  templateUrl: './estivage-centre-estivage-list-adherent.component.html',
  styleUrls: ['./estivage-centre-estivage-list-adherent.component.css']
})
export class EstivageCentreEstivageListAdherentComponent implements OnInit {
   // declarations
