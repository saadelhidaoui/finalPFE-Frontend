...
@Component({
  selector: 'app-enfant-list-adherent',
  templateUrl: './enfant-list-adherent.component.html',
  styleUrls: ['./enfant-list-adherent.component.css']
})
export class EnfantListAdherentComponent implements OnInit {
   // declarations
