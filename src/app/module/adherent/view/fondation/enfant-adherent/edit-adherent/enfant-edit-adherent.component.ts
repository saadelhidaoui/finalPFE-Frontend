...
@Component({
  selector: 'app-enfant-edit-adherent',
  templateUrl: './enfant-edit-adherent.component.html',
  styleUrls: ['./enfant-edit-adherent.component.css']
})
export class EnfantEditAdherentComponent implements OnInit {
