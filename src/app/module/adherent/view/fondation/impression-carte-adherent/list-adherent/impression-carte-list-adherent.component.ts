...
@Component({
  selector: 'app-impression-carte-list-adherent',
  templateUrl: './impression-carte-list-adherent.component.html',
  styleUrls: ['./impression-carte-list-adherent.component.css']
})
export class ImpressionCarteListAdherentComponent implements OnInit {
   // declarations
