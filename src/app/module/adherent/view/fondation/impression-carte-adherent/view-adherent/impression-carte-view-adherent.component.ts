...
@Component({
  selector: 'app-impression-carte-view-adherent',
  templateUrl: './impression-carte-view-adherent.component.html',
  styleUrls: ['./impression-carte-view-adherent.component.css']
})
export class ImpressionCarteViewAdherentComponent implements OnInit {
