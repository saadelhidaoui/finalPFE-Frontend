...
@Component({
  selector: 'app-impression-carte-edit-adherent',
  templateUrl: './impression-carte-edit-adherent.component.html',
  styleUrls: ['./impression-carte-edit-adherent.component.css']
})
export class ImpressionCarteEditAdherentComponent implements OnInit {
