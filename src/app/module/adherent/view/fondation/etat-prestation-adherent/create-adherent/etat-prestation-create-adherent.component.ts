...
@Component({
  selector: 'app-etat-prestation-create-adherent',
  templateUrl: './etat-prestation-create-adherent.component.html',
  styleUrls: ['./etat-prestation-create-adherent.component.css']
})
export class EtatPrestationCreateAdherentComponent implements OnInit {
