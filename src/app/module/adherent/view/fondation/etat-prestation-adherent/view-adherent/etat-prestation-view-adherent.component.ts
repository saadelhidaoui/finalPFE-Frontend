...
@Component({
  selector: 'app-etat-prestation-view-adherent',
  templateUrl: './etat-prestation-view-adherent.component.html',
  styleUrls: ['./etat-prestation-view-adherent.component.css']
})
export class EtatPrestationViewAdherentComponent implements OnInit {
