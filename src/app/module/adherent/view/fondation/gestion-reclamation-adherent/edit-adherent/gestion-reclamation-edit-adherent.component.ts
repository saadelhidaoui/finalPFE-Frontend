...
@Component({
  selector: 'app-gestion-reclamation-edit-adherent',
  templateUrl: './gestion-reclamation-edit-adherent.component.html',
  styleUrls: ['./gestion-reclamation-edit-adherent.component.css']
})
export class GestionReclamationEditAdherentComponent implements OnInit {
