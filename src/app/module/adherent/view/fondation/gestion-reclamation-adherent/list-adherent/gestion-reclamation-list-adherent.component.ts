...
@Component({
  selector: 'app-gestion-reclamation-list-adherent',
  templateUrl: './gestion-reclamation-list-adherent.component.html',
  styleUrls: ['./gestion-reclamation-list-adherent.component.css']
})
export class GestionReclamationListAdherentComponent implements OnInit {
   // declarations
