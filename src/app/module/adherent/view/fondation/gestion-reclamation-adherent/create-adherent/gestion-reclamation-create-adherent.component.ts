...
@Component({
  selector: 'app-gestion-reclamation-create-adherent',
  templateUrl: './gestion-reclamation-create-adherent.component.html',
  styleUrls: ['./gestion-reclamation-create-adherent.component.css']
})
export class GestionReclamationCreateAdherentComponent implements OnInit {
