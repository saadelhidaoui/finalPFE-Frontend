...
@Component({
  selector: 'app-gestion-reclamation-view-adherent',
  templateUrl: './gestion-reclamation-view-adherent.component.html',
  styleUrls: ['./gestion-reclamation-view-adherent.component.css']
})
export class GestionReclamationViewAdherentComponent implements OnInit {
