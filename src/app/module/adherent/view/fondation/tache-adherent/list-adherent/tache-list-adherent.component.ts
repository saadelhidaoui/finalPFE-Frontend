...
@Component({
  selector: 'app-tache-list-adherent',
  templateUrl: './tache-list-adherent.component.html',
  styleUrls: ['./tache-list-adherent.component.css']
})
export class TacheListAdherentComponent implements OnInit {
   // declarations
