...
@Component({
  selector: 'app-tache-edit-adherent',
  templateUrl: './tache-edit-adherent.component.html',
  styleUrls: ['./tache-edit-adherent.component.css']
})
export class TacheEditAdherentComponent implements OnInit {
