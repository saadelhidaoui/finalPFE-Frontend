...
@Component({
  selector: 'app-tache-view-adherent',
  templateUrl: './tache-view-adherent.component.html',
  styleUrls: ['./tache-view-adherent.component.css']
})
export class TacheViewAdherentComponent implements OnInit {
