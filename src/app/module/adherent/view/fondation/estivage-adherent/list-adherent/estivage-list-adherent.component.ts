...
@Component({
  selector: 'app-estivage-list-adherent',
  templateUrl: './estivage-list-adherent.component.html',
  styleUrls: ['./estivage-list-adherent.component.css']
})
export class EstivageListAdherentComponent implements OnInit {
   // declarations
