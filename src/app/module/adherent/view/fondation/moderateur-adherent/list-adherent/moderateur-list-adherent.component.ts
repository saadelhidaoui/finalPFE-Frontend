...
@Component({
  selector: 'app-moderateur-list-adherent',
  templateUrl: './moderateur-list-adherent.component.html',
  styleUrls: ['./moderateur-list-adherent.component.css']
})
export class ModerateurListAdherentComponent implements OnInit {
   // declarations
