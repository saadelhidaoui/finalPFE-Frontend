...
@Component({
  selector: 'app-moderateur-view-adherent',
  templateUrl: './moderateur-view-adherent.component.html',
  styleUrls: ['./moderateur-view-adherent.component.css']
})
export class ModerateurViewAdherentComponent implements OnInit {
