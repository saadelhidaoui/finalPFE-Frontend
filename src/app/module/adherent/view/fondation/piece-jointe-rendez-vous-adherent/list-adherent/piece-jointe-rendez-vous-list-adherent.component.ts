...
@Component({
  selector: 'app-piece-jointe-rendez-vous-list-adherent',
  templateUrl: './piece-jointe-rendez-vous-list-adherent.component.html',
  styleUrls: ['./piece-jointe-rendez-vous-list-adherent.component.css']
})
export class PieceJointeRendezVousListAdherentComponent implements OnInit {
   // declarations
