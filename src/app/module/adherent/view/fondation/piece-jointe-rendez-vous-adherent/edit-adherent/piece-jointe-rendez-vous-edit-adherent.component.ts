...
@Component({
  selector: 'app-piece-jointe-rendez-vous-edit-adherent',
  templateUrl: './piece-jointe-rendez-vous-edit-adherent.component.html',
  styleUrls: ['./piece-jointe-rendez-vous-edit-adherent.component.css']
})
export class PieceJointeRendezVousEditAdherentComponent implements OnInit {
