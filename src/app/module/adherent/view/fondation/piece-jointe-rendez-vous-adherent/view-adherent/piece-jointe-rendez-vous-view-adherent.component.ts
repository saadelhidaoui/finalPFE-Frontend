...
@Component({
  selector: 'app-piece-jointe-rendez-vous-view-adherent',
  templateUrl: './piece-jointe-rendez-vous-view-adherent.component.html',
  styleUrls: ['./piece-jointe-rendez-vous-view-adherent.component.css']
})
export class PieceJointeRendezVousViewAdherentComponent implements OnInit {
