...
@Component({
  selector: 'app-ville-view-adherent',
  templateUrl: './ville-view-adherent.component.html',
  styleUrls: ['./ville-view-adherent.component.css']
})
export class VilleViewAdherentComponent implements OnInit {
