...
@Component({
  selector: 'app-ville-list-adherent',
  templateUrl: './ville-list-adherent.component.html',
  styleUrls: ['./ville-list-adherent.component.css']
})
export class VilleListAdherentComponent implements OnInit {
   // declarations
