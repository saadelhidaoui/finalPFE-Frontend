...
@Component({
  selector: 'app-etat-tache-view-adherent',
  templateUrl: './etat-tache-view-adherent.component.html',
  styleUrls: ['./etat-tache-view-adherent.component.css']
})
export class EtatTacheViewAdherentComponent implements OnInit {
