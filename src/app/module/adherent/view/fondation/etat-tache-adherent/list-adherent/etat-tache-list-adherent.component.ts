...
@Component({
  selector: 'app-etat-tache-list-adherent',
  templateUrl: './etat-tache-list-adherent.component.html',
  styleUrls: ['./etat-tache-list-adherent.component.css']
})
export class EtatTacheListAdherentComponent implements OnInit {
   // declarations
