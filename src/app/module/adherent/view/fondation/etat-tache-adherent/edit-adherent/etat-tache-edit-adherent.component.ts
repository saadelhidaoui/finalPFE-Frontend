...
@Component({
  selector: 'app-etat-tache-edit-adherent',
  templateUrl: './etat-tache-edit-adherent.component.html',
  styleUrls: ['./etat-tache-edit-adherent.component.css']
})
export class EtatTacheEditAdherentComponent implements OnInit {
