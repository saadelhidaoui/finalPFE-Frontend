...
@Component({
  selector: 'app-etat-projet-edit-adherent',
  templateUrl: './etat-projet-edit-adherent.component.html',
  styleUrls: ['./etat-projet-edit-adherent.component.css']
})
export class EtatProjetEditAdherentComponent implements OnInit {
