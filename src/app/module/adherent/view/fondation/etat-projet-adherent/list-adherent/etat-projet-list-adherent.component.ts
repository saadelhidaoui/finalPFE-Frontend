...
@Component({
  selector: 'app-etat-projet-list-adherent',
  templateUrl: './etat-projet-list-adherent.component.html',
  styleUrls: ['./etat-projet-list-adherent.component.css']
})
export class EtatProjetListAdherentComponent implements OnInit {
   // declarations
