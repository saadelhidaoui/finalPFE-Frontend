...
@Component({
  selector: 'app-echelon-list-adherent',
  templateUrl: './echelon-list-adherent.component.html',
  styleUrls: ['./echelon-list-adherent.component.css']
})
export class EchelonListAdherentComponent implements OnInit {
   // declarations
