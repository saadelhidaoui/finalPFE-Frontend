...
@Component({
  selector: 'app-echelon-view-adherent',
  templateUrl: './echelon-view-adherent.component.html',
  styleUrls: ['./echelon-view-adherent.component.css']
})
export class EchelonViewAdherentComponent implements OnInit {
