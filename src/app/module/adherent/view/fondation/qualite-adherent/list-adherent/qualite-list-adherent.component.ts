...
@Component({
  selector: 'app-qualite-list-adherent',
  templateUrl: './qualite-list-adherent.component.html',
  styleUrls: ['./qualite-list-adherent.component.css']
})
export class QualiteListAdherentComponent implements OnInit {
   // declarations
