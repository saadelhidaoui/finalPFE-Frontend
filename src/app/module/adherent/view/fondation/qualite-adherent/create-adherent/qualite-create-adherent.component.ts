...
@Component({
  selector: 'app-qualite-create-adherent',
  templateUrl: './qualite-create-adherent.component.html',
  styleUrls: ['./qualite-create-adherent.component.css']
})
export class QualiteCreateAdherentComponent implements OnInit {
