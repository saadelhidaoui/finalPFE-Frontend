...
@Component({
  selector: 'app-qualite-view-adherent',
  templateUrl: './qualite-view-adherent.component.html',
  styleUrls: ['./qualite-view-adherent.component.css']
})
export class QualiteViewAdherentComponent implements OnInit {
