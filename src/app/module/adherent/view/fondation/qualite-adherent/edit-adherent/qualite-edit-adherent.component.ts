...
@Component({
  selector: 'app-qualite-edit-adherent',
  templateUrl: './qualite-edit-adherent.component.html',
  styleUrls: ['./qualite-edit-adherent.component.css']
})
export class QualiteEditAdherentComponent implements OnInit {
