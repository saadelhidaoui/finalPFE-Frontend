...
@Component({
  selector: 'app-etat-carte-view-adherent',
  templateUrl: './etat-carte-view-adherent.component.html',
  styleUrls: ['./etat-carte-view-adherent.component.css']
})
export class EtatCarteViewAdherentComponent implements OnInit {
