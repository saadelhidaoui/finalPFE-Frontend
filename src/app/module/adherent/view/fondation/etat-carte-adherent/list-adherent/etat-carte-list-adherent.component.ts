...
@Component({
  selector: 'app-etat-carte-list-adherent',
  templateUrl: './etat-carte-list-adherent.component.html',
  styleUrls: ['./etat-carte-list-adherent.component.css']
})
export class EtatCarteListAdherentComponent implements OnInit {
   // declarations
