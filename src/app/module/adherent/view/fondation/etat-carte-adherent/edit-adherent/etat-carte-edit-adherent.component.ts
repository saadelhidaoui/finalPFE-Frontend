...
@Component({
  selector: 'app-etat-carte-edit-adherent',
  templateUrl: './etat-carte-edit-adherent.component.html',
  styleUrls: ['./etat-carte-edit-adherent.component.css']
})
export class EtatCarteEditAdherentComponent implements OnInit {
