...
@Component({
  selector: 'app-etat-carte-create-adherent',
  templateUrl: './etat-carte-create-adherent.component.html',
  styleUrls: ['./etat-carte-create-adherent.component.css']
})
export class EtatCarteCreateAdherentComponent implements OnInit {
