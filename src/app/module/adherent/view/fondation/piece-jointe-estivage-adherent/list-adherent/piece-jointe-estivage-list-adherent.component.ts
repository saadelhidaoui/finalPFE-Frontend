...
@Component({
  selector: 'app-piece-jointe-estivage-list-adherent',
  templateUrl: './piece-jointe-estivage-list-adherent.component.html',
  styleUrls: ['./piece-jointe-estivage-list-adherent.component.css']
})
export class PieceJointeEstivageListAdherentComponent implements OnInit {
   // declarations
