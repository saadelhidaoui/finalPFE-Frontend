...
@Component({
  selector: 'app-piece-jointe-projet-edit-adherent',
  templateUrl: './piece-jointe-projet-edit-adherent.component.html',
  styleUrls: ['./piece-jointe-projet-edit-adherent.component.css']
})
export class PieceJointeProjetEditAdherentComponent implements OnInit {
