...
@Component({
  selector: 'app-centre-estivage-create-adherent',
  templateUrl: './centre-estivage-create-adherent.component.html',
  styleUrls: ['./centre-estivage-create-adherent.component.css']
})
export class CentreEstivageCreateAdherentComponent implements OnInit {
