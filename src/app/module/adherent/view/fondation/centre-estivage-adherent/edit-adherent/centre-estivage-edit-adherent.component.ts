...
@Component({
  selector: 'app-centre-estivage-edit-adherent',
  templateUrl: './centre-estivage-edit-adherent.component.html',
  styleUrls: ['./centre-estivage-edit-adherent.component.css']
})
export class CentreEstivageEditAdherentComponent implements OnInit {
