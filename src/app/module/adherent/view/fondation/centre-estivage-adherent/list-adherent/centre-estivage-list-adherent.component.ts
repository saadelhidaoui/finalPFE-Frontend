...
@Component({
  selector: 'app-centre-estivage-list-adherent',
  templateUrl: './centre-estivage-list-adherent.component.html',
  styleUrls: ['./centre-estivage-list-adherent.component.css']
})
export class CentreEstivageListAdherentComponent implements OnInit {
   // declarations
