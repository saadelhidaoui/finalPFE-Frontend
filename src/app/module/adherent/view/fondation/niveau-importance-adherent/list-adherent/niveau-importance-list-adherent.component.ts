...
@Component({
  selector: 'app-niveau-importance-list-adherent',
  templateUrl: './niveau-importance-list-adherent.component.html',
  styleUrls: ['./niveau-importance-list-adherent.component.css']
})
export class NiveauImportanceListAdherentComponent implements OnInit {
   // declarations
