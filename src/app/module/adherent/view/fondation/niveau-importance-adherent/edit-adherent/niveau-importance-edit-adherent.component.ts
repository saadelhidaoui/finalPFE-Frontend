...
@Component({
  selector: 'app-niveau-importance-edit-adherent',
  templateUrl: './niveau-importance-edit-adherent.component.html',
  styleUrls: ['./niveau-importance-edit-adherent.component.css']
})
export class NiveauImportanceEditAdherentComponent implements OnInit {
