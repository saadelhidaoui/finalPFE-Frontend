...
@Component({
  selector: 'app-statut-create-adherent',
  templateUrl: './statut-create-adherent.component.html',
  styleUrls: ['./statut-create-adherent.component.css']
})
export class StatutCreateAdherentComponent implements OnInit {
