...
@Component({
  selector: 'app-projet-view-adherent',
  templateUrl: './projet-view-adherent.component.html',
  styleUrls: ['./projet-view-adherent.component.css']
})
export class ProjetViewAdherentComponent implements OnInit {
