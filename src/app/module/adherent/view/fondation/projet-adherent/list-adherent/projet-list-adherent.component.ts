...
@Component({
  selector: 'app-projet-list-adherent',
  templateUrl: './projet-list-adherent.component.html',
  styleUrls: ['./projet-list-adherent.component.css']
})
export class ProjetListAdherentComponent implements OnInit {
   // declarations
