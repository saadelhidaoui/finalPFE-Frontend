...
@Component({
  selector: 'app-projet-edit-adherent',
  templateUrl: './projet-edit-adherent.component.html',
  styleUrls: ['./projet-edit-adherent.component.css']
})
export class ProjetEditAdherentComponent implements OnInit {
