...
@Component({
  selector: 'app-demande-estivage-list-adherent',
  templateUrl: './demande-estivage-list-adherent.component.html',
  styleUrls: ['./demande-estivage-list-adherent.component.css']
})
export class DemandeEstivageListAdherentComponent implements OnInit {
   // declarations
