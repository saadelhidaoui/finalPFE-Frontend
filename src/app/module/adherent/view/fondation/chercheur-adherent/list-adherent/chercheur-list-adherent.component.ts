...
@Component({
  selector: 'app-chercheur-list-adherent',
  templateUrl: './chercheur-list-adherent.component.html',
  styleUrls: ['./chercheur-list-adherent.component.css']
})
export class ChercheurListAdherentComponent implements OnInit {
   // declarations
