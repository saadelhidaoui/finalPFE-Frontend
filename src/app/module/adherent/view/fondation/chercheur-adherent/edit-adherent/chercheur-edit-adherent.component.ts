...
@Component({
  selector: 'app-chercheur-edit-adherent',
  templateUrl: './chercheur-edit-adherent.component.html',
  styleUrls: ['./chercheur-edit-adherent.component.css']
})
export class ChercheurEditAdherentComponent implements OnInit {
