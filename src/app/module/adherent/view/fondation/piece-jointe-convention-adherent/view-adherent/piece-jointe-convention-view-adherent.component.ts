...
@Component({
  selector: 'app-piece-jointe-convention-view-adherent',
  templateUrl: './piece-jointe-convention-view-adherent.component.html',
  styleUrls: ['./piece-jointe-convention-view-adherent.component.css']
})
export class PieceJointeConventionViewAdherentComponent implements OnInit {
