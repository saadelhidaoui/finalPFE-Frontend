...
@Component({
  selector: 'app-piece-jointe-convention-list-adherent',
  templateUrl: './piece-jointe-convention-list-adherent.component.html',
  styleUrls: ['./piece-jointe-convention-list-adherent.component.css']
})
export class PieceJointeConventionListAdherentComponent implements OnInit {
   // declarations
