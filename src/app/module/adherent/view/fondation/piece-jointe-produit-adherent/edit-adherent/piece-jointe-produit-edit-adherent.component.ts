...
@Component({
  selector: 'app-piece-jointe-produit-edit-adherent',
  templateUrl: './piece-jointe-produit-edit-adherent.component.html',
  styleUrls: ['./piece-jointe-produit-edit-adherent.component.css']
})
export class PieceJointeProduitEditAdherentComponent implements OnInit {
