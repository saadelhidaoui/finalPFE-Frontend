...
@Component({
  selector: 'app-piece-jointe-produit-list-adherent',
  templateUrl: './piece-jointe-produit-list-adherent.component.html',
  styleUrls: ['./piece-jointe-produit-list-adherent.component.css']
})
export class PieceJointeProduitListAdherentComponent implements OnInit {
   // declarations
