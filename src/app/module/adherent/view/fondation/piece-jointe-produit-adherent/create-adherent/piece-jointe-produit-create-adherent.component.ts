...
@Component({
  selector: 'app-piece-jointe-produit-create-adherent',
  templateUrl: './piece-jointe-produit-create-adherent.component.html',
  styleUrls: ['./piece-jointe-produit-create-adherent.component.css']
})
export class PieceJointeProduitCreateAdherentComponent implements OnInit {
