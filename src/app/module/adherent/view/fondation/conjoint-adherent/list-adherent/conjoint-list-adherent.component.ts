...
@Component({
  selector: 'app-conjoint-list-adherent',
  templateUrl: './conjoint-list-adherent.component.html',
  styleUrls: ['./conjoint-list-adherent.component.css']
})
export class ConjointListAdherentComponent implements OnInit {
   // declarations
