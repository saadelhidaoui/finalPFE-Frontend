...
@Component({
  selector: 'app-conjoint-view-adherent',
  templateUrl: './conjoint-view-adherent.component.html',
  styleUrls: ['./conjoint-view-adherent.component.css']
})
export class ConjointViewAdherentComponent implements OnInit {
