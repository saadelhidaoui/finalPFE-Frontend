...
@Component({
  selector: 'app-enfant-list-moderateur',
  templateUrl: './enfant-list-moderateur.component.html',
  styleUrls: ['./enfant-list-moderateur.component.css']
})
export class EnfantListModerateurComponent implements OnInit {
   // declarations
