...
@Component({
  selector: 'app-enfant-view-moderateur',
  templateUrl: './enfant-view-moderateur.component.html',
  styleUrls: ['./enfant-view-moderateur.component.css']
})
export class EnfantViewModerateurComponent implements OnInit {
