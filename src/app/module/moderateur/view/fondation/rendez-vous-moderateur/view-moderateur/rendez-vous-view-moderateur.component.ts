...
@Component({
  selector: 'app-rendez-vous-view-moderateur',
  templateUrl: './rendez-vous-view-moderateur.component.html',
  styleUrls: ['./rendez-vous-view-moderateur.component.css']
})
export class RendezVousViewModerateurComponent implements OnInit {
