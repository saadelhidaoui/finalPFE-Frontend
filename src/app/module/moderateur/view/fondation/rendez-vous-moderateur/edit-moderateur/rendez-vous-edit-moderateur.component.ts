...
@Component({
  selector: 'app-rendez-vous-edit-moderateur',
  templateUrl: './rendez-vous-edit-moderateur.component.html',
  styleUrls: ['./rendez-vous-edit-moderateur.component.css']
})
export class RendezVousEditModerateurComponent implements OnInit {
