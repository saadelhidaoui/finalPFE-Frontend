...
@Component({
  selector: 'app-echelle-edit-moderateur',
  templateUrl: './echelle-edit-moderateur.component.html',
  styleUrls: ['./echelle-edit-moderateur.component.css']
})
export class EchelleEditModerateurComponent implements OnInit {
