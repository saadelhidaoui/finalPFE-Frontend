...
@Component({
  selector: 'app-echelle-list-moderateur',
  templateUrl: './echelle-list-moderateur.component.html',
  styleUrls: ['./echelle-list-moderateur.component.css']
})
export class EchelleListModerateurComponent implements OnInit {
   // declarations
