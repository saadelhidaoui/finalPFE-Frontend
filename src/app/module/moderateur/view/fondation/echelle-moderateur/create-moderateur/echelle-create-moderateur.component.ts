...
@Component({
  selector: 'app-echelle-create-moderateur',
  templateUrl: './echelle-create-moderateur.component.html',
  styleUrls: ['./echelle-create-moderateur.component.css']
})
export class EchelleCreateModerateurComponent implements OnInit {
