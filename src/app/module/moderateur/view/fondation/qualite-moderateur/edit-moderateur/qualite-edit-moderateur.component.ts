...
@Component({
  selector: 'app-qualite-edit-moderateur',
  templateUrl: './qualite-edit-moderateur.component.html',
  styleUrls: ['./qualite-edit-moderateur.component.css']
})
export class QualiteEditModerateurComponent implements OnInit {
