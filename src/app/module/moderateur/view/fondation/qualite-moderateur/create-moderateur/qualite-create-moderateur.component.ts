...
@Component({
  selector: 'app-qualite-create-moderateur',
  templateUrl: './qualite-create-moderateur.component.html',
  styleUrls: ['./qualite-create-moderateur.component.css']
})
export class QualiteCreateModerateurComponent implements OnInit {
