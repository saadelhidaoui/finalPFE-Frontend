...
@Component({
  selector: 'app-qualite-list-moderateur',
  templateUrl: './qualite-list-moderateur.component.html',
  styleUrls: ['./qualite-list-moderateur.component.css']
})
export class QualiteListModerateurComponent implements OnInit {
   // declarations
