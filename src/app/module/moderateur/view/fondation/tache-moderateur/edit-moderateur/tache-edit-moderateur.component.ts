...
@Component({
  selector: 'app-tache-edit-moderateur',
  templateUrl: './tache-edit-moderateur.component.html',
  styleUrls: ['./tache-edit-moderateur.component.css']
})
export class TacheEditModerateurComponent implements OnInit {
