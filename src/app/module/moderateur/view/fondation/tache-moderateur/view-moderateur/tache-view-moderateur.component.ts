...
@Component({
  selector: 'app-tache-view-moderateur',
  templateUrl: './tache-view-moderateur.component.html',
  styleUrls: ['./tache-view-moderateur.component.css']
})
export class TacheViewModerateurComponent implements OnInit {
