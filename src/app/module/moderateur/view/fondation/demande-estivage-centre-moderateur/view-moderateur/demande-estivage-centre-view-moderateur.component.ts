...
@Component({
  selector: 'app-demande-estivage-centre-view-moderateur',
  templateUrl: './demande-estivage-centre-view-moderateur.component.html',
  styleUrls: ['./demande-estivage-centre-view-moderateur.component.css']
})
export class DemandeEstivageCentreViewModerateurComponent implements OnInit {
