...
@Component({
  selector: 'app-piece-jointe-convention-edit-moderateur',
  templateUrl: './piece-jointe-convention-edit-moderateur.component.html',
  styleUrls: ['./piece-jointe-convention-edit-moderateur.component.css']
})
export class PieceJointeConventionEditModerateurComponent implements OnInit {
