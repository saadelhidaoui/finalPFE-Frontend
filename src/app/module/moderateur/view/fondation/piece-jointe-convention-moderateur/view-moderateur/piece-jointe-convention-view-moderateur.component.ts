...
@Component({
  selector: 'app-piece-jointe-convention-view-moderateur',
  templateUrl: './piece-jointe-convention-view-moderateur.component.html',
  styleUrls: ['./piece-jointe-convention-view-moderateur.component.css']
})
export class PieceJointeConventionViewModerateurComponent implements OnInit {
