...
@Component({
  selector: 'app-etat-carte-edit-moderateur',
  templateUrl: './etat-carte-edit-moderateur.component.html',
  styleUrls: ['./etat-carte-edit-moderateur.component.css']
})
export class EtatCarteEditModerateurComponent implements OnInit {
