...
@Component({
  selector: 'app-demande-estivage-edit-moderateur',
  templateUrl: './demande-estivage-edit-moderateur.component.html',
  styleUrls: ['./demande-estivage-edit-moderateur.component.css']
})
export class DemandeEstivageEditModerateurComponent implements OnInit {
