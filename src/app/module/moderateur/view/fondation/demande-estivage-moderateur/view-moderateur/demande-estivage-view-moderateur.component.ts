...
@Component({
  selector: 'app-demande-estivage-view-moderateur',
  templateUrl: './demande-estivage-view-moderateur.component.html',
  styleUrls: ['./demande-estivage-view-moderateur.component.css']
})
export class DemandeEstivageViewModerateurComponent implements OnInit {
