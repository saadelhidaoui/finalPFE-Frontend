...
@Component({
  selector: 'app-echelon-list-moderateur',
  templateUrl: './echelon-list-moderateur.component.html',
  styleUrls: ['./echelon-list-moderateur.component.css']
})
export class EchelonListModerateurComponent implements OnInit {
   // declarations
