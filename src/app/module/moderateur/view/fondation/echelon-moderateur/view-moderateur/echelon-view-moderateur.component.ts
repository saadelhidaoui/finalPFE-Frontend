...
@Component({
  selector: 'app-echelon-view-moderateur',
  templateUrl: './echelon-view-moderateur.component.html',
  styleUrls: ['./echelon-view-moderateur.component.css']
})
export class EchelonViewModerateurComponent implements OnInit {
