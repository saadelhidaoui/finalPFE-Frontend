...
@Component({
  selector: 'app-grade-list-moderateur',
  templateUrl: './grade-list-moderateur.component.html',
  styleUrls: ['./grade-list-moderateur.component.css']
})
export class GradeListModerateurComponent implements OnInit {
   // declarations
...
public async duplicateGrade(grade: GradeVo) {
  ...
  initExport(): void {
    ...
    return {
      ...
      this.criteriaData = [{
            'Reference': this.searchGrade.reference ? this.searchGrade.reference : environment.emptyForExport ,
