...
@Component({
  selector: 'app-grade-view-moderateur',
  templateUrl: './grade-view-moderateur.component.html',
  styleUrls: ['./grade-view-moderateur.component.css']
})
export class GradeViewModerateurComponent implements OnInit {
