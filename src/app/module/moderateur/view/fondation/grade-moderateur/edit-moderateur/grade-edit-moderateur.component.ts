...
@Component({
  selector: 'app-grade-edit-moderateur',
  templateUrl: './grade-edit-moderateur.component.html',
  styleUrls: ['./grade-edit-moderateur.component.css']
})
export class GradeEditModerateurComponent implements OnInit {
