...
@Component({
  selector: 'app-type-prestation-view-moderateur',
  templateUrl: './type-prestation-view-moderateur.component.html',
  styleUrls: ['./type-prestation-view-moderateur.component.css']
})
export class TypePrestationViewModerateurComponent implements OnInit {
