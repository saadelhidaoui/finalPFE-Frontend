...
@Component({
  selector: 'app-type-prestation-list-moderateur',
  templateUrl: './type-prestation-list-moderateur.component.html',
  styleUrls: ['./type-prestation-list-moderateur.component.css']
})
export class TypePrestationListModerateurComponent implements OnInit {
   // declarations
