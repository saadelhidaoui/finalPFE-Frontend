...
@Component({
  selector: 'app-type-prestation-create-moderateur',
  templateUrl: './type-prestation-create-moderateur.component.html',
  styleUrls: ['./type-prestation-create-moderateur.component.css']
})
export class TypePrestationCreateModerateurComponent implements OnInit {
