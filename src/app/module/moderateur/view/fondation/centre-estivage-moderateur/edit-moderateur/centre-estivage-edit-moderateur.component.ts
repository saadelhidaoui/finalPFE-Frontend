...
@Component({
  selector: 'app-centre-estivage-edit-moderateur',
  templateUrl: './centre-estivage-edit-moderateur.component.html',
  styleUrls: ['./centre-estivage-edit-moderateur.component.css']
})
export class CentreEstivageEditModerateurComponent implements OnInit {
