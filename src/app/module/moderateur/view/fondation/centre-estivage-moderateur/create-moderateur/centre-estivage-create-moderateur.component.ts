...
@Component({
  selector: 'app-centre-estivage-create-moderateur',
  templateUrl: './centre-estivage-create-moderateur.component.html',
  styleUrls: ['./centre-estivage-create-moderateur.component.css']
})
export class CentreEstivageCreateModerateurComponent implements OnInit {
