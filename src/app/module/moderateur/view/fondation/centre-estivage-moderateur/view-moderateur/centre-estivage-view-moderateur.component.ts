...
@Component({
  selector: 'app-centre-estivage-view-moderateur',
  templateUrl: './centre-estivage-view-moderateur.component.html',
  styleUrls: ['./centre-estivage-view-moderateur.component.css']
})
export class CentreEstivageViewModerateurComponent implements OnInit {
