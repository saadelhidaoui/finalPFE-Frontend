...
@Component({
  selector: 'app-piece-jointe-projet-create-moderateur',
  templateUrl: './piece-jointe-projet-create-moderateur.component.html',
  styleUrls: ['./piece-jointe-projet-create-moderateur.component.css']
})
export class PieceJointeProjetCreateModerateurComponent implements OnInit {
