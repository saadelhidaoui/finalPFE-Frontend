...
@Component({
  selector: 'app-piece-jointe-projet-list-moderateur',
  templateUrl: './piece-jointe-projet-list-moderateur.component.html',
  styleUrls: ['./piece-jointe-projet-list-moderateur.component.css']
})
export class PieceJointeProjetListModerateurComponent implements OnInit {
   // declarations
