...
@Component({
  selector: 'app-piece-jointe-projet-edit-moderateur',
  templateUrl: './piece-jointe-projet-edit-moderateur.component.html',
  styleUrls: ['./piece-jointe-projet-edit-moderateur.component.css']
})
export class PieceJointeProjetEditModerateurComponent implements OnInit {
