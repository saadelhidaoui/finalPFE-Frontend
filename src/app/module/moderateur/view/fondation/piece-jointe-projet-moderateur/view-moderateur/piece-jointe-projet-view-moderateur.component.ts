...
@Component({
  selector: 'app-piece-jointe-projet-view-moderateur',
  templateUrl: './piece-jointe-projet-view-moderateur.component.html',
  styleUrls: ['./piece-jointe-projet-view-moderateur.component.css']
})
export class PieceJointeProjetViewModerateurComponent implements OnInit {
