...
@Component({
  selector: 'app-statut-list-moderateur',
  templateUrl: './statut-list-moderateur.component.html',
  styleUrls: ['./statut-list-moderateur.component.css']
})
export class StatutListModerateurComponent implements OnInit {
   // declarations
