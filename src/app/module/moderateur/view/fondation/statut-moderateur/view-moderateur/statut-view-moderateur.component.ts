...
@Component({
  selector: 'app-statut-view-moderateur',
  templateUrl: './statut-view-moderateur.component.html',
  styleUrls: ['./statut-view-moderateur.component.css']
})
export class StatutViewModerateurComponent implements OnInit {
