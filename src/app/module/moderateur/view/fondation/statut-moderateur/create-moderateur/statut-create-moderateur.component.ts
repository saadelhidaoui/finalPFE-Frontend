...
@Component({
  selector: 'app-statut-create-moderateur',
  templateUrl: './statut-create-moderateur.component.html',
  styleUrls: ['./statut-create-moderateur.component.css']
})
export class StatutCreateModerateurComponent implements OnInit {
