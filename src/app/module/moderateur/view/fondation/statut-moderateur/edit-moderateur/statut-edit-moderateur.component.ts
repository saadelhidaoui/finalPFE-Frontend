...
@Component({
  selector: 'app-statut-edit-moderateur',
  templateUrl: './statut-edit-moderateur.component.html',
  styleUrls: ['./statut-edit-moderateur.component.css']
})
export class StatutEditModerateurComponent implements OnInit {
