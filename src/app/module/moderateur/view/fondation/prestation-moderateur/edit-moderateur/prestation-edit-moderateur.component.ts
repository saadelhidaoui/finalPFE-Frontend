...
@Component({
  selector: 'app-prestation-edit-moderateur',
  templateUrl: './prestation-edit-moderateur.component.html',
  styleUrls: ['./prestation-edit-moderateur.component.css']
})
export class PrestationEditModerateurComponent implements OnInit {
