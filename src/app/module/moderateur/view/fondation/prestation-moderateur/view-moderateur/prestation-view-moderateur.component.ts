...
@Component({
  selector: 'app-prestation-view-moderateur',
  templateUrl: './prestation-view-moderateur.component.html',
  styleUrls: ['./prestation-view-moderateur.component.css']
})
export class PrestationViewModerateurComponent implements OnInit {
