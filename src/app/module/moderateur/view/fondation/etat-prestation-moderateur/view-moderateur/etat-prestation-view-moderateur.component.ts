...
@Component({
  selector: 'app-etat-prestation-view-moderateur',
  templateUrl: './etat-prestation-view-moderateur.component.html',
  styleUrls: ['./etat-prestation-view-moderateur.component.css']
})
export class EtatPrestationViewModerateurComponent implements OnInit {
