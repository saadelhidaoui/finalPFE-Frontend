...
@Component({
  selector: 'app-etat-prestation-list-moderateur',
  templateUrl: './etat-prestation-list-moderateur.component.html',
  styleUrls: ['./etat-prestation-list-moderateur.component.css']
})
export class EtatPrestationListModerateurComponent implements OnInit {
   // declarations
