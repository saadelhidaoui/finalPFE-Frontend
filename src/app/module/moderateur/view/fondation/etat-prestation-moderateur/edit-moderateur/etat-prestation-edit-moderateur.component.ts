...
@Component({
  selector: 'app-etat-prestation-edit-moderateur',
  templateUrl: './etat-prestation-edit-moderateur.component.html',
  styleUrls: ['./etat-prestation-edit-moderateur.component.css']
})
export class EtatPrestationEditModerateurComponent implements OnInit {
