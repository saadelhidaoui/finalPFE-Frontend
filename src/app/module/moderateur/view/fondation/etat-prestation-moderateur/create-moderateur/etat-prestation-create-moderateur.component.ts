...
@Component({
  selector: 'app-etat-prestation-create-moderateur',
  templateUrl: './etat-prestation-create-moderateur.component.html',
  styleUrls: ['./etat-prestation-create-moderateur.component.css']
})
export class EtatPrestationCreateModerateurComponent implements OnInit {
