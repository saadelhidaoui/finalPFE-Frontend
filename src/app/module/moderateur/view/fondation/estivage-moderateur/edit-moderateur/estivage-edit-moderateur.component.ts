...
@Component({
  selector: 'app-estivage-edit-moderateur',
  templateUrl: './estivage-edit-moderateur.component.html',
  styleUrls: ['./estivage-edit-moderateur.component.css']
})
export class EstivageEditModerateurComponent implements OnInit {
