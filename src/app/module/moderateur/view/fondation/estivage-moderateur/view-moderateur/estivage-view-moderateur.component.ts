...
@Component({
  selector: 'app-estivage-view-moderateur',
  templateUrl: './estivage-view-moderateur.component.html',
  styleUrls: ['./estivage-view-moderateur.component.css']
})
export class EstivageViewModerateurComponent implements OnInit {
