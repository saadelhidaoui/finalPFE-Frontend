...
@Component({
  selector: 'app-impression-carte-create-moderateur',
  templateUrl: './impression-carte-create-moderateur.component.html',
  styleUrls: ['./impression-carte-create-moderateur.component.css']
})
export class ImpressionCarteCreateModerateurComponent implements OnInit {
