...
@Component({
  selector: 'app-impression-carte-view-moderateur',
  templateUrl: './impression-carte-view-moderateur.component.html',
  styleUrls: ['./impression-carte-view-moderateur.component.css']
})
export class ImpressionCarteViewModerateurComponent implements OnInit {
