...
@Component({
  selector: 'app-impression-carte-list-moderateur',
  templateUrl: './impression-carte-list-moderateur.component.html',
  styleUrls: ['./impression-carte-list-moderateur.component.css']
})
export class ImpressionCarteListModerateurComponent implements OnInit {
   // declarations
