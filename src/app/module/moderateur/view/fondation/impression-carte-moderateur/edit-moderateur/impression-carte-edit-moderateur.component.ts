...
@Component({
  selector: 'app-impression-carte-edit-moderateur',
  templateUrl: './impression-carte-edit-moderateur.component.html',
  styleUrls: ['./impression-carte-edit-moderateur.component.css']
})
export class ImpressionCarteEditModerateurComponent implements OnInit {
