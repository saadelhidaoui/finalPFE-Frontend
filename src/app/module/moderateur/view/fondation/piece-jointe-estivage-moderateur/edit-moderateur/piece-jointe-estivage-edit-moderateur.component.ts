...
@Component({
  selector: 'app-piece-jointe-estivage-edit-moderateur',
  templateUrl: './piece-jointe-estivage-edit-moderateur.component.html',
  styleUrls: ['./piece-jointe-estivage-edit-moderateur.component.css']
})
export class PieceJointeEstivageEditModerateurComponent implements OnInit {
