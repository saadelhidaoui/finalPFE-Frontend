...
@Component({
  selector: 'app-piece-jointe-estivage-view-moderateur',
  templateUrl: './piece-jointe-estivage-view-moderateur.component.html',
  styleUrls: ['./piece-jointe-estivage-view-moderateur.component.css']
})
export class PieceJointeEstivageViewModerateurComponent implements OnInit {
