...
@Component({
  selector: 'app-profil-view-moderateur',
  templateUrl: './profil-view-moderateur.component.html',
  styleUrls: ['./profil-view-moderateur.component.css']
})
export class ProfilViewModerateurComponent implements OnInit {
