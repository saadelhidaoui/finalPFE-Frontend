...
@Component({
  selector: 'app-profil-list-moderateur',
  templateUrl: './profil-list-moderateur.component.html',
  styleUrls: ['./profil-list-moderateur.component.css']
})
export class ProfilListModerateurComponent implements OnInit {
   // declarations
