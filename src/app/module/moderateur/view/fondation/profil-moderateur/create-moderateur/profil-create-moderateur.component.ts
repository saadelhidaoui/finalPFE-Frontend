...
@Component({
  selector: 'app-profil-create-moderateur',
  templateUrl: './profil-create-moderateur.component.html',
  styleUrls: ['./profil-create-moderateur.component.css']
})
export class ProfilCreateModerateurComponent implements OnInit {
