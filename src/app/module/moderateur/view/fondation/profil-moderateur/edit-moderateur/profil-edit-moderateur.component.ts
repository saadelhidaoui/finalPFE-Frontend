...
@Component({
  selector: 'app-profil-edit-moderateur',
  templateUrl: './profil-edit-moderateur.component.html',
  styleUrls: ['./profil-edit-moderateur.component.css']
})
export class ProfilEditModerateurComponent implements OnInit {
