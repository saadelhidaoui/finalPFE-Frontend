...
@Component({
  selector: 'app-reclamation-view-moderateur',
  templateUrl: './reclamation-view-moderateur.component.html',
  styleUrls: ['./reclamation-view-moderateur.component.css']
})
export class ReclamationViewModerateurComponent implements OnInit {
