...
@Component({
  selector: 'app-reclamation-create-moderateur',
  templateUrl: './reclamation-create-moderateur.component.html',
  styleUrls: ['./reclamation-create-moderateur.component.css']
})
export class ReclamationCreateModerateurComponent implements OnInit {
