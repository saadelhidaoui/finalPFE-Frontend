...
@Component({
  selector: 'app-reclamation-list-moderateur',
  templateUrl: './reclamation-list-moderateur.component.html',
  styleUrls: ['./reclamation-list-moderateur.component.css']
})
export class ReclamationListModerateurComponent implements OnInit {
   // declarations
