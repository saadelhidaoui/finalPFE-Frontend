...
@Component({
  selector: 'app-moderateur-create-moderateur',
  templateUrl: './moderateur-create-moderateur.component.html',
  styleUrls: ['./moderateur-create-moderateur.component.css']
})
export class ModerateurCreateModerateurComponent implements OnInit {
