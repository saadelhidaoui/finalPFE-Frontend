...
@Component({
  selector: 'app-moderateur-list-moderateur',
  templateUrl: './moderateur-list-moderateur.component.html',
  styleUrls: ['./moderateur-list-moderateur.component.css']
})
export class ModerateurListModerateurComponent implements OnInit {
   // declarations
