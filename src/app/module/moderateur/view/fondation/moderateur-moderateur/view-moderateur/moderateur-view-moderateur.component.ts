...
@Component({
  selector: 'app-moderateur-view-moderateur',
  templateUrl: './moderateur-view-moderateur.component.html',
  styleUrls: ['./moderateur-view-moderateur.component.css']
})
export class ModerateurViewModerateurComponent implements OnInit {
