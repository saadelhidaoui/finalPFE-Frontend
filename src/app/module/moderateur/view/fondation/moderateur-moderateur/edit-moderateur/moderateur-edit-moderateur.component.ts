...
@Component({
  selector: 'app-moderateur-edit-moderateur',
  templateUrl: './moderateur-edit-moderateur.component.html',
  styleUrls: ['./moderateur-edit-moderateur.component.css']
})
export class ModerateurEditModerateurComponent implements OnInit {
