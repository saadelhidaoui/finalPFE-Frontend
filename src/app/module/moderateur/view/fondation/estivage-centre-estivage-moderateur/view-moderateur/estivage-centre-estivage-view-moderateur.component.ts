...
@Component({
  selector: 'app-estivage-centre-estivage-view-moderateur',
  templateUrl: './estivage-centre-estivage-view-moderateur.component.html',
  styleUrls: ['./estivage-centre-estivage-view-moderateur.component.css']
})
export class EstivageCentreEstivageViewModerateurComponent implements OnInit {
