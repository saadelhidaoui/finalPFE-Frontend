...
@Component({
  selector: 'app-estivage-centre-estivage-edit-moderateur',
  templateUrl: './estivage-centre-estivage-edit-moderateur.component.html',
  styleUrls: ['./estivage-centre-estivage-edit-moderateur.component.css']
})
export class EstivageCentreEstivageEditModerateurComponent implements OnInit {
