...
@Component({
  selector: 'app-estivage-centre-estivage-list-moderateur',
  templateUrl: './estivage-centre-estivage-list-moderateur.component.html',
  styleUrls: ['./estivage-centre-estivage-list-moderateur.component.css']
})
export class EstivageCentreEstivageListModerateurComponent implements OnInit {
   // declarations
