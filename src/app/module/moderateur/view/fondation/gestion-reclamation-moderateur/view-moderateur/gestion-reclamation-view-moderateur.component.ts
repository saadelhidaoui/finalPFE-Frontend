...
@Component({
  selector: 'app-gestion-reclamation-view-moderateur',
  templateUrl: './gestion-reclamation-view-moderateur.component.html',
  styleUrls: ['./gestion-reclamation-view-moderateur.component.css']
})
export class GestionReclamationViewModerateurComponent implements OnInit {
