...
@Component({
  selector: 'app-gestion-reclamation-create-moderateur',
  templateUrl: './gestion-reclamation-create-moderateur.component.html',
  styleUrls: ['./gestion-reclamation-create-moderateur.component.css']
})
export class GestionReclamationCreateModerateurComponent implements OnInit {
