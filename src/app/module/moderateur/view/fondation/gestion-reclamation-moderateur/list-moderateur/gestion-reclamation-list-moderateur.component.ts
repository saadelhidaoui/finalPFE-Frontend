...
@Component({
  selector: 'app-gestion-reclamation-list-moderateur',
  templateUrl: './gestion-reclamation-list-moderateur.component.html',
  styleUrls: ['./gestion-reclamation-list-moderateur.component.css']
})
export class GestionReclamationListModerateurComponent implements OnInit {
   // declarations
