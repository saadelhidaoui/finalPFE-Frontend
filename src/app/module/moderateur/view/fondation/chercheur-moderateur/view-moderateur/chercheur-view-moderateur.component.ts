...
@Component({
  selector: 'app-chercheur-view-moderateur',
  templateUrl: './chercheur-view-moderateur.component.html',
  styleUrls: ['./chercheur-view-moderateur.component.css']
})
export class ChercheurViewModerateurComponent implements OnInit {
