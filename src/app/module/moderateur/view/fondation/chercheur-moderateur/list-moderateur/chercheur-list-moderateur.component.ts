...
@Component({
  selector: 'app-chercheur-list-moderateur',
  templateUrl: './chercheur-list-moderateur.component.html',
  styleUrls: ['./chercheur-list-moderateur.component.css']
})
export class ChercheurListModerateurComponent implements OnInit {
   // declarations
  ...
  initExport(): void {
    ...
    return {
      ...
      this.criteriaData = [{
        ...
        'Situation moderateur': this.searchChercheur.situationModerateurVo?.libelle ? this.searchChercheur.situationModerateurVo?.libelle : environment.emptyForExport ,
        'Profil': this.searchChercheur.profilVo?.libelle ? this.searchChercheur.profilVo?.libelle : environment.emptyForExport ,
     }];
