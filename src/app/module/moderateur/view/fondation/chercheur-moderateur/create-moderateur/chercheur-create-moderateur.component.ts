...
@Component({
  selector: 'app-chercheur-create-moderateur',
  templateUrl: './chercheur-create-moderateur.component.html',
  styleUrls: ['./chercheur-create-moderateur.component.css']
})
export class ChercheurCreateModerateurComponent implements OnInit {
