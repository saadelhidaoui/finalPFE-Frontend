...
@Component({
  selector: 'app-mission-view-moderateur',
  templateUrl: './mission-view-moderateur.component.html',
  styleUrls: ['./mission-view-moderateur.component.css']
})
export class MissionViewModerateurComponent implements OnInit {
