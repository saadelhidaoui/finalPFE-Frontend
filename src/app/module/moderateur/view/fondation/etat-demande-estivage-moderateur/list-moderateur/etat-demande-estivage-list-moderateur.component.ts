...
@Component({
  selector: 'app-etat-demande-estivage-list-moderateur',
  templateUrl: './etat-demande-estivage-list-moderateur.component.html',
  styleUrls: ['./etat-demande-estivage-list-moderateur.component.css']
})
export class EtatDemandeEstivageListModerateurComponent implements OnInit {
   // declarations
