...
@Component({
  selector: 'app-etat-demande-estivage-create-moderateur',
  templateUrl: './etat-demande-estivage-create-moderateur.component.html',
  styleUrls: ['./etat-demande-estivage-create-moderateur.component.css']
})
export class EtatDemandeEstivageCreateModerateurComponent implements OnInit {
