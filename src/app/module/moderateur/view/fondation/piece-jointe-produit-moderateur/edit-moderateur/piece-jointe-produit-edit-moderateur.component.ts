...
@Component({
  selector: 'app-piece-jointe-produit-edit-moderateur',
  templateUrl: './piece-jointe-produit-edit-moderateur.component.html',
  styleUrls: ['./piece-jointe-produit-edit-moderateur.component.css']
})
export class PieceJointeProduitEditModerateurComponent implements OnInit {
