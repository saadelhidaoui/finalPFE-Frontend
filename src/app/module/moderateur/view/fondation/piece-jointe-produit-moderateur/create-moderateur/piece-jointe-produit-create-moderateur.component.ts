...
@Component({
  selector: 'app-piece-jointe-produit-create-moderateur',
  templateUrl: './piece-jointe-produit-create-moderateur.component.html',
  styleUrls: ['./piece-jointe-produit-create-moderateur.component.css']
})
export class PieceJointeProduitCreateModerateurComponent implements OnInit {
