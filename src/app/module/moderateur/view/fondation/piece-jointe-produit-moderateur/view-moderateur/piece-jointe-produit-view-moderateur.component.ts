...
@Component({
  selector: 'app-piece-jointe-produit-view-moderateur',
  templateUrl: './piece-jointe-produit-view-moderateur.component.html',
  styleUrls: ['./piece-jointe-produit-view-moderateur.component.css']
})
export class PieceJointeProduitViewModerateurComponent implements OnInit {
