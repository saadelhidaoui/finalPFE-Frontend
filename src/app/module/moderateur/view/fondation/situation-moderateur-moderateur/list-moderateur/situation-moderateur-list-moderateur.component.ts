...
@Component({
  selector: 'app-situation-moderateur-list-moderateur',
  templateUrl: './situation-moderateur-list-moderateur.component.html',
  styleUrls: ['./situation-moderateur-list-moderateur.component.css']
})
export class SituationModerateurListModerateurComponent implements OnInit {
   // declarations
