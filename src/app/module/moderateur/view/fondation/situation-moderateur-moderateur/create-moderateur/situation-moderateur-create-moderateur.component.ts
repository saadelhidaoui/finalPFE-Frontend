...
@Component({
  selector: 'app-situation-moderateur-create-moderateur',
  templateUrl: './situation-moderateur-create-moderateur.component.html',
  styleUrls: ['./situation-moderateur-create-moderateur.component.css']
})
export class SituationModerateurCreateModerateurComponent implements OnInit {
