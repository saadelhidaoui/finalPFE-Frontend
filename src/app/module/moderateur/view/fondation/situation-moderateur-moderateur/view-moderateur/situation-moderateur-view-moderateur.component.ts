...
@Component({
  selector: 'app-situation-moderateur-view-moderateur',
  templateUrl: './situation-moderateur-view-moderateur.component.html',
  styleUrls: ['./situation-moderateur-view-moderateur.component.css']
})
export class SituationModerateurViewModerateurComponent implements OnInit {
