...
@Component({
  selector: 'app-produit-create-moderateur',
  templateUrl: './produit-create-moderateur.component.html',
  styleUrls: ['./produit-create-moderateur.component.css']
})
export class ProduitCreateModerateurComponent implements OnInit {
