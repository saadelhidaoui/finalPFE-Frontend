...
@Component({
  selector: 'app-produit-edit-moderateur',
  templateUrl: './produit-edit-moderateur.component.html',
  styleUrls: ['./produit-edit-moderateur.component.css']
})
export class ProduitEditModerateurComponent implements OnInit {
