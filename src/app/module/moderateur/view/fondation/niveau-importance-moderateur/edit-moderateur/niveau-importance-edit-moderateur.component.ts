...
@Component({
  selector: 'app-niveau-importance-edit-moderateur',
  templateUrl: './niveau-importance-edit-moderateur.component.html',
  styleUrls: ['./niveau-importance-edit-moderateur.component.css']
})
export class NiveauImportanceEditModerateurComponent implements OnInit {
