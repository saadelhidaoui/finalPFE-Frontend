...
@Component({
  selector: 'app-niveau-importance-list-moderateur',
  templateUrl: './niveau-importance-list-moderateur.component.html',
  styleUrls: ['./niveau-importance-list-moderateur.component.css']
})
export class NiveauImportanceListModerateurComponent implements OnInit {
   // declarations
