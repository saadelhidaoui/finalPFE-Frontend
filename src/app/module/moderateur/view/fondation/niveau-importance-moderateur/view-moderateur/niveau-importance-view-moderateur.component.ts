...
@Component({
  selector: 'app-niveau-importance-view-moderateur',
  templateUrl: './niveau-importance-view-moderateur.component.html',
  styleUrls: ['./niveau-importance-view-moderateur.component.css']
})
export class NiveauImportanceViewModerateurComponent implements OnInit {
