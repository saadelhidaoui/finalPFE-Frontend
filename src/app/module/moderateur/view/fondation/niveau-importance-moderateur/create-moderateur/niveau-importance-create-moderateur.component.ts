...
@Component({
  selector: 'app-niveau-importance-create-moderateur',
  templateUrl: './niveau-importance-create-moderateur.component.html',
  styleUrls: ['./niveau-importance-create-moderateur.component.css']
})
export class NiveauImportanceCreateModerateurComponent implements OnInit {
