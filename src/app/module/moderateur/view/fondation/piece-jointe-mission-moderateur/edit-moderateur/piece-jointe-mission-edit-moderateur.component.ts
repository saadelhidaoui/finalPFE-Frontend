...
@Component({
  selector: 'app-piece-jointe-mission-edit-moderateur',
  templateUrl: './piece-jointe-mission-edit-moderateur.component.html',
  styleUrls: ['./piece-jointe-mission-edit-moderateur.component.css']
})
export class PieceJointeMissionEditModerateurComponent implements OnInit {
