...
@Component({
  selector: 'app-piece-jointe-mission-view-moderateur',
  templateUrl: './piece-jointe-mission-view-moderateur.component.html',
  styleUrls: ['./piece-jointe-mission-view-moderateur.component.css']
})
export class PieceJointeMissionViewModerateurComponent implements OnInit {
