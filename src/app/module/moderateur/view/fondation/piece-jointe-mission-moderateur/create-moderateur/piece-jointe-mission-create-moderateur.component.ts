...
@Component({
  selector: 'app-piece-jointe-mission-create-moderateur',
  templateUrl: './piece-jointe-mission-create-moderateur.component.html',
  styleUrls: ['./piece-jointe-mission-create-moderateur.component.css']
})
export class PieceJointeMissionCreateModerateurComponent implements OnInit {
