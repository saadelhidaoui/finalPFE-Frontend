...
@Component({
  selector: 'app-etat-projet-view-moderateur',
  templateUrl: './etat-projet-view-moderateur.component.html',
  styleUrls: ['./etat-projet-view-moderateur.component.css']
})
export class EtatProjetViewModerateurComponent implements OnInit {
