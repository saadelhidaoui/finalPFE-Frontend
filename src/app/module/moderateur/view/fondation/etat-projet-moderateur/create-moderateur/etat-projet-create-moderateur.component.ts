...
@Component({
  selector: 'app-etat-projet-create-moderateur',
  templateUrl: './etat-projet-create-moderateur.component.html',
  styleUrls: ['./etat-projet-create-moderateur.component.css']
})
export class EtatProjetCreateModerateurComponent implements OnInit {
