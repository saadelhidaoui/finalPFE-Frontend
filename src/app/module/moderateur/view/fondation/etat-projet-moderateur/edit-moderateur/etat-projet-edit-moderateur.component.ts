...
@Component({
  selector: 'app-etat-projet-edit-moderateur',
  templateUrl: './etat-projet-edit-moderateur.component.html',
  styleUrls: ['./etat-projet-edit-moderateur.component.css']
})
export class EtatProjetEditModerateurComponent implements OnInit {
