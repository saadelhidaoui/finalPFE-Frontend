...
@Component({
  selector: 'app-adherent-view-moderateur',
  templateUrl: './adherent-view-moderateur.component.html',
  styleUrls: ['./adherent-view-moderateur.component.css']
})
export class AdherentViewModerateurComponent implements OnInit {
