...
@Component({
  selector: 'app-organisme-list-moderateur',
  templateUrl: './organisme-list-moderateur.component.html',
  styleUrls: ['./organisme-list-moderateur.component.css']
})
export class OrganismeListModerateurComponent implements OnInit {
   // declarations
