...
@Component({
  selector: 'app-organisme-edit-moderateur',
  templateUrl: './organisme-edit-moderateur.component.html',
  styleUrls: ['./organisme-edit-moderateur.component.css']
})
export class OrganismeEditModerateurComponent implements OnInit {
