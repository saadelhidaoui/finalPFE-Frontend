...
@Component({
  selector: 'app-piece-jointe-adherent-edit-moderateur',
  templateUrl: './piece-jointe-adherent-edit-moderateur.component.html',
  styleUrls: ['./piece-jointe-adherent-edit-moderateur.component.css']
})
export class PieceJointeAdherentEditModerateurComponent implements OnInit {
