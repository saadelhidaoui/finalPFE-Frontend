...
@Component({
  selector: 'app-piece-jointe-adherent-create-moderateur',
  templateUrl: './piece-jointe-adherent-create-moderateur.component.html',
  styleUrls: ['./piece-jointe-adherent-create-moderateur.component.css']
})
export class PieceJointeAdherentCreateModerateurComponent implements OnInit {
