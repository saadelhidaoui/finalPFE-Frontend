...
@Component({
  selector: 'app-piece-jointe-adherent-view-moderateur',
  templateUrl: './piece-jointe-adherent-view-moderateur.component.html',
  styleUrls: ['./piece-jointe-adherent-view-moderateur.component.css']
})
export class PieceJointeAdherentViewModerateurComponent implements OnInit {
