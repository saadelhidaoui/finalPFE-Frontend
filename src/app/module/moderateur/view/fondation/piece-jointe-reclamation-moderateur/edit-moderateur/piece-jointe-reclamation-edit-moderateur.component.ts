...
@Component({
  selector: 'app-piece-jointe-reclamation-edit-moderateur',
  templateUrl: './piece-jointe-reclamation-edit-moderateur.component.html',
  styleUrls: ['./piece-jointe-reclamation-edit-moderateur.component.css']
})
export class PieceJointeReclamationEditModerateurComponent implements OnInit {
