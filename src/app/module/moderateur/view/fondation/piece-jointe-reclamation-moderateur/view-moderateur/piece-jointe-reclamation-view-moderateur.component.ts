...
@Component({
  selector: 'app-piece-jointe-reclamation-view-moderateur',
  templateUrl: './piece-jointe-reclamation-view-moderateur.component.html',
  styleUrls: ['./piece-jointe-reclamation-view-moderateur.component.css']
})
export class PieceJointeReclamationViewModerateurComponent implements OnInit {
