...
@Component({
  selector: 'app-piece-jointe-reclamation-list-moderateur',
  templateUrl: './piece-jointe-reclamation-list-moderateur.component.html',
  styleUrls: ['./piece-jointe-reclamation-list-moderateur.component.css']
})
export class PieceJointeReclamationListModerateurComponent implements OnInit {
   // declarations
