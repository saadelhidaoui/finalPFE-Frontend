...
@Component({
  selector: 'app-convention-list-moderateur',
  templateUrl: './convention-list-moderateur.component.html',
  styleUrls: ['./convention-list-moderateur.component.css']
})
export class ConventionListModerateurComponent implements OnInit {
   // declarations
