...
@Component({
  selector: 'app-fonction-edit-moderateur',
  templateUrl: './fonction-edit-moderateur.component.html',
  styleUrls: ['./fonction-edit-moderateur.component.css']
})
export class FonctionEditModerateurComponent implements OnInit {
