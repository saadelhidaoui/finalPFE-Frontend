...
@Component({
  selector: 'app-fonction-list-moderateur',
  templateUrl: './fonction-list-moderateur.component.html',
  styleUrls: ['./fonction-list-moderateur.component.css']
})
export class FonctionListModerateurComponent implements OnInit {
   // declarations
