...
@Component({
  selector: 'app-fonction-create-moderateur',
  templateUrl: './fonction-create-moderateur.component.html',
  styleUrls: ['./fonction-create-moderateur.component.css']
})
export class FonctionCreateModerateurComponent implements OnInit {
