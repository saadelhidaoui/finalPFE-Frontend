...
@Component({
  selector: 'app-projet-view-moderateur',
  templateUrl: './projet-view-moderateur.component.html',
  styleUrls: ['./projet-view-moderateur.component.css']
})
export class ProjetViewModerateurComponent implements OnInit {
