...
@Component({
  selector: 'app-projet-list-moderateur',
  templateUrl: './projet-list-moderateur.component.html',
  styleUrls: ['./projet-list-moderateur.component.css']
})
export class ProjetListModerateurComponent implements OnInit {
   // declarations
