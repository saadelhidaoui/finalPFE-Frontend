...
@Component({
  selector: 'app-projet-edit-moderateur',
  templateUrl: './projet-edit-moderateur.component.html',
  styleUrls: ['./projet-edit-moderateur.component.css']
})
export class ProjetEditModerateurComponent implements OnInit {
