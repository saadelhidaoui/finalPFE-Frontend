...
@Component({
  selector: 'app-etat-tache-create-moderateur',
  templateUrl: './etat-tache-create-moderateur.component.html',
  styleUrls: ['./etat-tache-create-moderateur.component.css']
})
export class EtatTacheCreateModerateurComponent implements OnInit {
