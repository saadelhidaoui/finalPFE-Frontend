...
@Component({
  selector: 'app-etat-tache-edit-moderateur',
  templateUrl: './etat-tache-edit-moderateur.component.html',
  styleUrls: ['./etat-tache-edit-moderateur.component.css']
})
export class EtatTacheEditModerateurComponent implements OnInit {
