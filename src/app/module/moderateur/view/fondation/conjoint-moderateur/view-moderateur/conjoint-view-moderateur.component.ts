...
@Component({
  selector: 'app-conjoint-view-moderateur',
  templateUrl: './conjoint-view-moderateur.component.html',
  styleUrls: ['./conjoint-view-moderateur.component.css']
})
export class ConjointViewModerateurComponent implements OnInit {
