...
@Component({
  selector: 'app-conjoint-edit-moderateur',
  templateUrl: './conjoint-edit-moderateur.component.html',
  styleUrls: ['./conjoint-edit-moderateur.component.css']
})
export class ConjointEditModerateurComponent implements OnInit {
