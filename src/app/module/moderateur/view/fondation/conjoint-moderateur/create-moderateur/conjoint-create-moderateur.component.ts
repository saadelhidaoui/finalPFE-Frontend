...
@Component({
  selector: 'app-conjoint-create-moderateur',
  templateUrl: './conjoint-create-moderateur.component.html',
  styleUrls: ['./conjoint-create-moderateur.component.css']
})
export class ConjointCreateModerateurComponent implements OnInit {
