...
@Component({
  selector: 'app-etat-reclamation-list-moderateur',
  templateUrl: './etat-reclamation-list-moderateur.component.html',
  styleUrls: ['./etat-reclamation-list-moderateur.component.css']
})
export class EtatReclamationListModerateurComponent implements OnInit {
   // declarations
...
public async duplicateEtatReclamation(etatReclamation: EtatReclamationVo) {
  ...
  initExport(): void {
    ...
    return {
      ...
      this.criteriaData = [{
            'Reference': this.searchEtatReclamation.reference ? this.searchEtatReclamation.reference : environment.emptyForExport ,
