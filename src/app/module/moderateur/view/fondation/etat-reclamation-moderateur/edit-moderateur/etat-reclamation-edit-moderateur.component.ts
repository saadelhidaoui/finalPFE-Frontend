...
@Component({
  selector: 'app-etat-reclamation-edit-moderateur',
  templateUrl: './etat-reclamation-edit-moderateur.component.html',
  styleUrls: ['./etat-reclamation-edit-moderateur.component.css']
})
export class EtatReclamationEditModerateurComponent implements OnInit {
