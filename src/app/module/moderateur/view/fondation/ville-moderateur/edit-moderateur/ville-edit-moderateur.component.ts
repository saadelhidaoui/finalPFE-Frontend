...
@Component({
  selector: 'app-ville-edit-moderateur',
  templateUrl: './ville-edit-moderateur.component.html',
  styleUrls: ['./ville-edit-moderateur.component.css']
})
export class VilleEditModerateurComponent implements OnInit {
