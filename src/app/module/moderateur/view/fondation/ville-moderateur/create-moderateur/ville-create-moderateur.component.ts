...
@Component({
  selector: 'app-ville-create-moderateur',
  templateUrl: './ville-create-moderateur.component.html',
  styleUrls: ['./ville-create-moderateur.component.css']
})
export class VilleCreateModerateurComponent implements OnInit {
