...
@Component({
  selector: 'app-ville-view-moderateur',
  templateUrl: './ville-view-moderateur.component.html',
  styleUrls: ['./ville-view-moderateur.component.css']
})
export class VilleViewModerateurComponent implements OnInit {
