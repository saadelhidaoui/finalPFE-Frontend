...
@Component({
  selector: 'app-region-create-moderateur',
  templateUrl: './region-create-moderateur.component.html',
  styleUrls: ['./region-create-moderateur.component.css']
})
export class RegionCreateModerateurComponent implements OnInit {
