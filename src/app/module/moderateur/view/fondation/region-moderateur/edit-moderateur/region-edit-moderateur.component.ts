...
@Component({
  selector: 'app-region-edit-moderateur',
  templateUrl: './region-edit-moderateur.component.html',
  styleUrls: ['./region-edit-moderateur.component.css']
})
export class RegionEditModerateurComponent implements OnInit {
