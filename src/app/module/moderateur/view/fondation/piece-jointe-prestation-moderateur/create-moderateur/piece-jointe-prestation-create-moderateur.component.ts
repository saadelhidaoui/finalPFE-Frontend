...
@Component({
  selector: 'app-piece-jointe-prestation-create-moderateur',
  templateUrl: './piece-jointe-prestation-create-moderateur.component.html',
  styleUrls: ['./piece-jointe-prestation-create-moderateur.component.css']
})
export class PieceJointePrestationCreateModerateurComponent implements OnInit {
