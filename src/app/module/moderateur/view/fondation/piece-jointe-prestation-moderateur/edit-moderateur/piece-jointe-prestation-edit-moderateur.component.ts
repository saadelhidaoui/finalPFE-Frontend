...
@Component({
  selector: 'app-piece-jointe-prestation-edit-moderateur',
  templateUrl: './piece-jointe-prestation-edit-moderateur.component.html',
  styleUrls: ['./piece-jointe-prestation-edit-moderateur.component.css']
})
export class PieceJointePrestationEditModerateurComponent implements OnInit {
