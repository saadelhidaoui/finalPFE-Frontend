...
@Component({
  selector: 'app-piece-jointe-prestation-list-moderateur',
  templateUrl: './piece-jointe-prestation-list-moderateur.component.html',
  styleUrls: ['./piece-jointe-prestation-list-moderateur.component.css']
})
export class PieceJointePrestationListModerateurComponent implements OnInit {
   // declarations
