...
@Component({
  selector: 'app-piece-jointe-rendez-vous-edit-moderateur',
  templateUrl: './piece-jointe-rendez-vous-edit-moderateur.component.html',
  styleUrls: ['./piece-jointe-rendez-vous-edit-moderateur.component.css']
})
export class PieceJointeRendezVousEditModerateurComponent implements OnInit {
