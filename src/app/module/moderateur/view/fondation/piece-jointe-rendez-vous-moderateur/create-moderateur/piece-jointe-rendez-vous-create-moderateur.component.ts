...
@Component({
  selector: 'app-piece-jointe-rendez-vous-create-moderateur',
  templateUrl: './piece-jointe-rendez-vous-create-moderateur.component.html',
  styleUrls: ['./piece-jointe-rendez-vous-create-moderateur.component.css']
})
export class PieceJointeRendezVousCreateModerateurComponent implements OnInit {
