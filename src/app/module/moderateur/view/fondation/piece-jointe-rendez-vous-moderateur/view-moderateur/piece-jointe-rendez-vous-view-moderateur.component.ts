...
@Component({
  selector: 'app-piece-jointe-rendez-vous-view-moderateur',
  templateUrl: './piece-jointe-rendez-vous-view-moderateur.component.html',
  styleUrls: ['./piece-jointe-rendez-vous-view-moderateur.component.css']
})
export class PieceJointeRendezVousViewModerateurComponent implements OnInit {
