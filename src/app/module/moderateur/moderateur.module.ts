...
import { FondationModerateurModule } from './view/Fondation/Fondation-moderateur.module';
import { FondationModerateurRoutingModule } from './view/Fondation/Fondation-moderateur-routing.module';
...
@NgModule({
  ...
  imports: [
    ...
    BadgeModule,
    MultiSelectModule,
  FondationModerateurModule,
  FondationModerateurRoutingModule,
  ],
  exports: [
  LoginModerateurComponent,
  RegisterModerateurComponent,
